...
// makeCMS3ClassFiles("/home/users/sjmay/Commissioning2017/NTupling/CMSSW_8_0_26_patch1/src/CMS3/NtupleMaker/test/ntuple.root", "Events", "CMS3", "tas", "cms3")
...
class CMS3 {
 ...
 protected: 
  ...
  vector<bool> elsBeforeGSFix_conv_vtx_flag_;
  TBranch *elsBeforeGSFix_conv_vtx_flag_branch;
  bool     elsBeforeGSFix_conv_vtx_flag_isLoaded;
  vector<bool> elsBeforeGSFix_isGsfCtfScPixChargeConsistent_;
  TBranch *elsBeforeGSFix_isGsfCtfScPixChargeConsistent_branch;
  bool     elsBeforeGSFix_isGsfCtfScPixChargeConsistent_isLoaded;
  vector<bool> elsBeforeGSFix_passingMvaPreselection_;
  TBranch *elsBeforeGSFix_passingMvaPreselection_branch;
  bool     elsBeforeGSFix_passingMvaPreselection_isLoaded;
  vector<bool> elsBeforeGSFix_passingPflowPreselection_;
  TBranch *elsBeforeGSFix_passingPflowPreselection_branch;
  bool     elsBeforeGSFix_passingPflowPreselection_isLoaded;
  ...
  vector<bool> pfcandsdiscard_isGlobalMuon_;
  TBranch *pfcandsdiscard_isGlobalMuon_branch;
  bool     pfcandsdiscard_isGlobalMuon_isLoaded;
  vector<bool> pfcandsdiscard_isStandAloneMuon_;
  TBranch *pfcandsdiscard_isStandAloneMuon_branch;
  bool     pfcandsdiscard_isStandAloneMuon_isLoaded;
  ...
  vector<bool> photonsBeforeGSFix_haspixelSeed_;
  TBranch *photonsBeforeGSFix_haspixelSeed_branch;
  bool     photonsBeforeGSFix_haspixelSeed_isLoaded;
  vector<bool> photonsBeforeGSFix_passElectronVeto_;
  TBranch *photonsBeforeGSFix_passElectronVeto_branch;
  bool     photonsBeforeGSFix_passElectronVeto_isLoaded;
  ...
  float    evt_egclean_calomet_;
  TBranch *evt_egclean_calomet_branch;
  bool     evt_egclean_calomet_isLoaded;
  float    evt_egclean_calometPhi_;
  TBranch *evt_egclean_calometPhi_branch;
  bool     evt_egclean_calometPhi_isLoaded;
  float    evt_egclean_pfmet_;
  TBranch *evt_egclean_pfmet_branch;
  bool     evt_egclean_pfmet_isLoaded;
  float    evt_egclean_pfmet_ElectronEnDown_;
  TBranch *evt_egclean_pfmet_ElectronEnDown_branch;
  bool     evt_egclean_pfmet_ElectronEnDown_isLoaded;
  float    evt_egclean_pfmet_ElectronEnUp_;
  TBranch *evt_egclean_pfmet_ElectronEnUp_branch;
  bool     evt_egclean_pfmet_ElectronEnUp_isLoaded;
  float    evt_egclean_pfmet_JetEnDown_;
  TBranch *evt_egclean_pfmet_JetEnDown_branch;
  bool     evt_egclean_pfmet_JetEnDown_isLoaded;
  float    evt_egclean_pfmet_JetEnUp_;
  TBranch *evt_egclean_pfmet_JetEnUp_branch;
  bool     evt_egclean_pfmet_JetEnUp_isLoaded;
  float    evt_egclean_pfmet_JetResDown_;
  TBranch *evt_egclean_pfmet_JetResDown_branch;
  bool     evt_egclean_pfmet_JetResDown_isLoaded;
  float    evt_egclean_pfmet_JetResUp_;
  TBranch *evt_egclean_pfmet_JetResUp_branch;
  bool     evt_egclean_pfmet_JetResUp_isLoaded;
  float    evt_egclean_pfmet_MuonEnDown_;
  TBranch *evt_egclean_pfmet_MuonEnDown_branch;
  bool     evt_egclean_pfmet_MuonEnDown_isLoaded;
  float    evt_egclean_pfmet_MuonEnUp_;
  TBranch *evt_egclean_pfmet_MuonEnUp_branch;
  bool     evt_egclean_pfmet_MuonEnUp_isLoaded;
  float    evt_egclean_pfmetPhi_;
  TBranch *evt_egclean_pfmetPhi_branch;
  bool     evt_egclean_pfmetPhi_isLoaded;
  float    evt_egclean_pfmetPhi_ElectronEnDown_;
  TBranch *evt_egclean_pfmetPhi_ElectronEnDown_branch;
  bool     evt_egclean_pfmetPhi_ElectronEnDown_isLoaded;
  float    evt_egclean_pfmetPhi_ElectronEnUp_;
  TBranch *evt_egclean_pfmetPhi_ElectronEnUp_branch;
  bool     evt_egclean_pfmetPhi_ElectronEnUp_isLoaded;
  float    evt_egclean_pfmetPhi_JetEnDown_;
  TBranch *evt_egclean_pfmetPhi_JetEnDown_branch;
  bool     evt_egclean_pfmetPhi_JetEnDown_isLoaded;
  float    evt_egclean_pfmetPhi_JetEnUp_;
  TBranch *evt_egclean_pfmetPhi_JetEnUp_branch;
  bool     evt_egclean_pfmetPhi_JetEnUp_isLoaded;
  float    evt_egclean_pfmetPhi_JetResDown_;
  TBranch *evt_egclean_pfmetPhi_JetResDown_branch;
  bool     evt_egclean_pfmetPhi_JetResDown_isLoaded;
  float    evt_egclean_pfmetPhi_JetResUp_;
  TBranch *evt_egclean_pfmetPhi_JetResUp_branch;
  bool     evt_egclean_pfmetPhi_JetResUp_isLoaded;
  float    evt_egclean_pfmetPhi_MuonEnDown_;
  TBranch *evt_egclean_pfmetPhi_MuonEnDown_branch;
  bool     evt_egclean_pfmetPhi_MuonEnDown_isLoaded;
  float    evt_egclean_pfmetPhi_MuonEnUp_;
  TBranch *evt_egclean_pfmetPhi_MuonEnUp_branch;
  bool     evt_egclean_pfmetPhi_MuonEnUp_isLoaded;
  float    evt_egclean_pfmetPhi_PhotonEnDown_;
  TBranch *evt_egclean_pfmetPhi_PhotonEnDown_branch;
  bool     evt_egclean_pfmetPhi_PhotonEnDown_isLoaded;
  float    evt_egclean_pfmetPhi_PhotonEnUp_;
  TBranch *evt_egclean_pfmetPhi_PhotonEnUp_branch;
  bool     evt_egclean_pfmetPhi_PhotonEnUp_isLoaded;
  float    evt_egclean_pfmetPhi_TauEnDown_;
  TBranch *evt_egclean_pfmetPhi_TauEnDown_branch;
  bool     evt_egclean_pfmetPhi_TauEnDown_isLoaded;
  float    evt_egclean_pfmetPhi_TauEnUp_;
  TBranch *evt_egclean_pfmetPhi_TauEnUp_branch;
  bool     evt_egclean_pfmetPhi_TauEnUp_isLoaded;
  float    evt_egclean_pfmetPhi_UnclusteredEnDown_;
  TBranch *evt_egclean_pfmetPhi_UnclusteredEnDown_branch;
  bool     evt_egclean_pfmetPhi_UnclusteredEnDown_isLoaded;
  float    evt_egclean_pfmetPhi_UnclusteredEnUp_;
  TBranch *evt_egclean_pfmetPhi_UnclusteredEnUp_branch;
  bool     evt_egclean_pfmetPhi_UnclusteredEnUp_isLoaded;
  float    evt_egclean_pfmetPhi_raw_;
  TBranch *evt_egclean_pfmetPhi_raw_branch;
  bool     evt_egclean_pfmetPhi_raw_isLoaded;
  float    evt_egclean_pfmet_PhotonEnDown_;
  TBranch *evt_egclean_pfmet_PhotonEnDown_branch;
  bool     evt_egclean_pfmet_PhotonEnDown_isLoaded;
  float    evt_egclean_pfmet_PhotonEnUp_;
  TBranch *evt_egclean_pfmet_PhotonEnUp_branch;
  bool     evt_egclean_pfmet_PhotonEnUp_isLoaded;
  float    evt_egclean_pfmetSig_;
  TBranch *evt_egclean_pfmetSig_branch;
  bool     evt_egclean_pfmetSig_isLoaded;
  float    evt_egclean_pfmetSignificance_;
  TBranch *evt_egclean_pfmetSignificance_branch;
  bool     evt_egclean_pfmetSignificance_isLoaded;
  float    evt_egclean_pfmet_TauEnDown_;
  TBranch *evt_egclean_pfmet_TauEnDown_branch;
  bool     evt_egclean_pfmet_TauEnDown_isLoaded;
  float    evt_egclean_pfmet_TauEnUp_;
  TBranch *evt_egclean_pfmet_TauEnUp_branch;
  bool     evt_egclean_pfmet_TauEnUp_isLoaded;
  float    evt_egclean_pfmet_UnclusteredEnDown_;
  TBranch *evt_egclean_pfmet_UnclusteredEnDown_branch;
  bool     evt_egclean_pfmet_UnclusteredEnDown_isLoaded;
  float    evt_egclean_pfmet_UnclusteredEnUp_;
  TBranch *evt_egclean_pfmet_UnclusteredEnUp_branch;
  bool     evt_egclean_pfmet_UnclusteredEnUp_isLoaded;
  float    evt_egclean_pfmet_raw_;
  TBranch *evt_egclean_pfmet_raw_branch;
  bool     evt_egclean_pfmet_raw_isLoaded;
  float    evt_egclean_pfsumet_;
  TBranch *evt_egclean_pfsumet_branch;
  bool     evt_egclean_pfsumet_isLoaded;
  float    evt_egclean_pfsumet_raw_;
  TBranch *evt_egclean_pfsumet_raw_branch;
  bool     evt_egclean_pfsumet_raw_isLoaded;
  float    evt_muegclean_calomet_;
  TBranch *evt_muegclean_calomet_branch;
  bool     evt_muegclean_calomet_isLoaded;
  float    evt_muegclean_calometPhi_;
  TBranch *evt_muegclean_calometPhi_branch;
  bool     evt_muegclean_calometPhi_isLoaded;
  float    evt_muegclean_pfmet_;
  TBranch *evt_muegclean_pfmet_branch;
  bool     evt_muegclean_pfmet_isLoaded;
  float    evt_muegclean_pfmet_ElectronEnDown_;
  TBranch *evt_muegclean_pfmet_ElectronEnDown_branch;
  bool     evt_muegclean_pfmet_ElectronEnDown_isLoaded;
  float    evt_muegclean_pfmet_ElectronEnUp_;
  TBranch *evt_muegclean_pfmet_ElectronEnUp_branch;
  bool     evt_muegclean_pfmet_ElectronEnUp_isLoaded;
  float    evt_muegclean_pfmet_JetEnDown_;
  TBranch *evt_muegclean_pfmet_JetEnDown_branch;
  bool     evt_muegclean_pfmet_JetEnDown_isLoaded;
  float    evt_muegclean_pfmet_JetEnUp_;
  TBranch *evt_muegclean_pfmet_JetEnUp_branch;
  bool     evt_muegclean_pfmet_JetEnUp_isLoaded;
  float    evt_muegclean_pfmet_JetResDown_;
  TBranch *evt_muegclean_pfmet_JetResDown_branch;
  bool     evt_muegclean_pfmet_JetResDown_isLoaded;
  float    evt_muegclean_pfmet_JetResUp_;
  TBranch *evt_muegclean_pfmet_JetResUp_branch;
  bool     evt_muegclean_pfmet_JetResUp_isLoaded;
  float    evt_muegclean_pfmet_MuonEnDown_;
  TBranch *evt_muegclean_pfmet_MuonEnDown_branch;
  bool     evt_muegclean_pfmet_MuonEnDown_isLoaded;
  float    evt_muegclean_pfmet_MuonEnUp_;
  TBranch *evt_muegclean_pfmet_MuonEnUp_branch;
  bool     evt_muegclean_pfmet_MuonEnUp_isLoaded;
  float    evt_muegclean_pfmetPhi_;
  TBranch *evt_muegclean_pfmetPhi_branch;
  bool     evt_muegclean_pfmetPhi_isLoaded;
  float    evt_muegclean_pfmetPhi_ElectronEnDown_;
  TBranch *evt_muegclean_pfmetPhi_ElectronEnDown_branch;
  bool     evt_muegclean_pfmetPhi_ElectronEnDown_isLoaded;
  float    evt_muegclean_pfmetPhi_ElectronEnUp_;
  TBranch *evt_muegclean_pfmetPhi_ElectronEnUp_branch;
  bool     evt_muegclean_pfmetPhi_ElectronEnUp_isLoaded;
  float    evt_muegclean_pfmetPhi_JetEnDown_;
  TBranch *evt_muegclean_pfmetPhi_JetEnDown_branch;
  bool     evt_muegclean_pfmetPhi_JetEnDown_isLoaded;
  float    evt_muegclean_pfmetPhi_JetEnUp_;
  TBranch *evt_muegclean_pfmetPhi_JetEnUp_branch;
  bool     evt_muegclean_pfmetPhi_JetEnUp_isLoaded;
  float    evt_muegclean_pfmetPhi_JetResDown_;
  TBranch *evt_muegclean_pfmetPhi_JetResDown_branch;
  bool     evt_muegclean_pfmetPhi_JetResDown_isLoaded;
  float    evt_muegclean_pfmetPhi_JetResUp_;
  TBranch *evt_muegclean_pfmetPhi_JetResUp_branch;
  bool     evt_muegclean_pfmetPhi_JetResUp_isLoaded;
  float    evt_muegclean_pfmetPhi_MuonEnDown_;
  TBranch *evt_muegclean_pfmetPhi_MuonEnDown_branch;
  bool     evt_muegclean_pfmetPhi_MuonEnDown_isLoaded;
  float    evt_muegclean_pfmetPhi_MuonEnUp_;
  TBranch *evt_muegclean_pfmetPhi_MuonEnUp_branch;
  bool     evt_muegclean_pfmetPhi_MuonEnUp_isLoaded;
  float    evt_muegclean_pfmetPhi_PhotonEnDown_;
  TBranch *evt_muegclean_pfmetPhi_PhotonEnDown_branch;
  bool     evt_muegclean_pfmetPhi_PhotonEnDown_isLoaded;
  float    evt_muegclean_pfmetPhi_PhotonEnUp_;
  TBranch *evt_muegclean_pfmetPhi_PhotonEnUp_branch;
  bool     evt_muegclean_pfmetPhi_PhotonEnUp_isLoaded;
  float    evt_muegclean_pfmetPhi_TauEnDown_;
  TBranch *evt_muegclean_pfmetPhi_TauEnDown_branch;
  bool     evt_muegclean_pfmetPhi_TauEnDown_isLoaded;
  float    evt_muegclean_pfmetPhi_TauEnUp_;
  TBranch *evt_muegclean_pfmetPhi_TauEnUp_branch;
  bool     evt_muegclean_pfmetPhi_TauEnUp_isLoaded;
  float    evt_muegclean_pfmetPhi_UnclusteredEnDown_;
  TBranch *evt_muegclean_pfmetPhi_UnclusteredEnDown_branch;
  bool     evt_muegclean_pfmetPhi_UnclusteredEnDown_isLoaded;
  float    evt_muegclean_pfmetPhi_UnclusteredEnUp_;
  TBranch *evt_muegclean_pfmetPhi_UnclusteredEnUp_branch;
  bool     evt_muegclean_pfmetPhi_UnclusteredEnUp_isLoaded;
  float    evt_muegclean_pfmetPhi_raw_;
  TBranch *evt_muegclean_pfmetPhi_raw_branch;
  bool     evt_muegclean_pfmetPhi_raw_isLoaded;
  float    evt_muegclean_pfmet_PhotonEnDown_;
  TBranch *evt_muegclean_pfmet_PhotonEnDown_branch;
  bool     evt_muegclean_pfmet_PhotonEnDown_isLoaded;
  float    evt_muegclean_pfmet_PhotonEnUp_;
  TBranch *evt_muegclean_pfmet_PhotonEnUp_branch;
  bool     evt_muegclean_pfmet_PhotonEnUp_isLoaded;
  float    evt_muegclean_pfmetSig_;
  TBranch *evt_muegclean_pfmetSig_branch;
  bool     evt_muegclean_pfmetSig_isLoaded;
  float    evt_muegclean_pfmetSignificance_;
  TBranch *evt_muegclean_pfmetSignificance_branch;
  bool     evt_muegclean_pfmetSignificance_isLoaded;
  float    evt_muegclean_pfmet_TauEnDown_;
  TBranch *evt_muegclean_pfmet_TauEnDown_branch;
  bool     evt_muegclean_pfmet_TauEnDown_isLoaded;
  float    evt_muegclean_pfmet_TauEnUp_;
  TBranch *evt_muegclean_pfmet_TauEnUp_branch;
  bool     evt_muegclean_pfmet_TauEnUp_isLoaded;
  float    evt_muegclean_pfmet_UnclusteredEnDown_;
  TBranch *evt_muegclean_pfmet_UnclusteredEnDown_branch;
  bool     evt_muegclean_pfmet_UnclusteredEnDown_isLoaded;
  float    evt_muegclean_pfmet_UnclusteredEnUp_;
  TBranch *evt_muegclean_pfmet_UnclusteredEnUp_branch;
  bool     evt_muegclean_pfmet_UnclusteredEnUp_isLoaded;
  float    evt_muegclean_pfmet_raw_;
  TBranch *evt_muegclean_pfmet_raw_branch;
  bool     evt_muegclean_pfmet_raw_isLoaded;
  float    evt_muegclean_pfsumet_;
  TBranch *evt_muegclean_pfsumet_branch;
  bool     evt_muegclean_pfsumet_isLoaded;
  float    evt_muegclean_pfsumet_raw_;
  TBranch *evt_muegclean_pfsumet_raw_branch;
  bool     evt_muegclean_pfsumet_raw_isLoaded;
  float    evt_muegcleanfix_calomet_;
  TBranch *evt_muegcleanfix_calomet_branch;
  bool     evt_muegcleanfix_calomet_isLoaded;
  float    evt_muegcleanfix_calometPhi_;
  TBranch *evt_muegcleanfix_calometPhi_branch;
  bool     evt_muegcleanfix_calometPhi_isLoaded;
  float    evt_muegcleanfix_pfmet_;
  TBranch *evt_muegcleanfix_pfmet_branch;
  bool     evt_muegcleanfix_pfmet_isLoaded;
  float    evt_muegcleanfix_pfmet_ElectronEnDown_;
  TBranch *evt_muegcleanfix_pfmet_ElectronEnDown_branch;
  bool     evt_muegcleanfix_pfmet_ElectronEnDown_isLoaded;
  float    evt_muegcleanfix_pfmet_ElectronEnUp_;
  TBranch *evt_muegcleanfix_pfmet_ElectronEnUp_branch;
  bool     evt_muegcleanfix_pfmet_ElectronEnUp_isLoaded;
  float    evt_muegcleanfix_pfmet_JetEnDown_;
  TBranch *evt_muegcleanfix_pfmet_JetEnDown_branch;
  bool     evt_muegcleanfix_pfmet_JetEnDown_isLoaded;
  float    evt_muegcleanfix_pfmet_JetEnUp_;
  TBranch *evt_muegcleanfix_pfmet_JetEnUp_branch;
  bool     evt_muegcleanfix_pfmet_JetEnUp_isLoaded;
  float    evt_muegcleanfix_pfmet_JetResDown_;
  TBranch *evt_muegcleanfix_pfmet_JetResDown_branch;
  bool     evt_muegcleanfix_pfmet_JetResDown_isLoaded;
  float    evt_muegcleanfix_pfmet_JetResUp_;
  TBranch *evt_muegcleanfix_pfmet_JetResUp_branch;
  bool     evt_muegcleanfix_pfmet_JetResUp_isLoaded;
  float    evt_muegcleanfix_pfmet_MuonEnDown_;
  TBranch *evt_muegcleanfix_pfmet_MuonEnDown_branch;
  bool     evt_muegcleanfix_pfmet_MuonEnDown_isLoaded;
  float    evt_muegcleanfix_pfmet_MuonEnUp_;
  TBranch *evt_muegcleanfix_pfmet_MuonEnUp_branch;
  bool     evt_muegcleanfix_pfmet_MuonEnUp_isLoaded;
  float    evt_muegcleanfix_pfmetPhi_;
  TBranch *evt_muegcleanfix_pfmetPhi_branch;
  bool     evt_muegcleanfix_pfmetPhi_isLoaded;
  float    evt_muegcleanfix_pfmetPhi_ElectronEnDown_;
  TBranch *evt_muegcleanfix_pfmetPhi_ElectronEnDown_branch;
  bool     evt_muegcleanfix_pfmetPhi_ElectronEnDown_isLoaded;
  float    evt_muegcleanfix_pfmetPhi_ElectronEnUp_;
  TBranch *evt_muegcleanfix_pfmetPhi_ElectronEnUp_branch;
  bool     evt_muegcleanfix_pfmetPhi_ElectronEnUp_isLoaded;
  float    evt_muegcleanfix_pfmetPhi_JetEnDown_;
  TBranch *evt_muegcleanfix_pfmetPhi_JetEnDown_branch;
  bool     evt_muegcleanfix_pfmetPhi_JetEnDown_isLoaded;
  float    evt_muegcleanfix_pfmetPhi_JetEnUp_;
  TBranch *evt_muegcleanfix_pfmetPhi_JetEnUp_branch;
  bool     evt_muegcleanfix_pfmetPhi_JetEnUp_isLoaded;
  float    evt_muegcleanfix_pfmetPhi_JetResDown_;
  TBranch *evt_muegcleanfix_pfmetPhi_JetResDown_branch;
  bool     evt_muegcleanfix_pfmetPhi_JetResDown_isLoaded;
  float    evt_muegcleanfix_pfmetPhi_JetResUp_;
  TBranch *evt_muegcleanfix_pfmetPhi_JetResUp_branch;
  bool     evt_muegcleanfix_pfmetPhi_JetResUp_isLoaded;
  float    evt_muegcleanfix_pfmetPhi_MuonEnDown_;
  TBranch *evt_muegcleanfix_pfmetPhi_MuonEnDown_branch;
  bool     evt_muegcleanfix_pfmetPhi_MuonEnDown_isLoaded;
  float    evt_muegcleanfix_pfmetPhi_MuonEnUp_;
  TBranch *evt_muegcleanfix_pfmetPhi_MuonEnUp_branch;
  bool     evt_muegcleanfix_pfmetPhi_MuonEnUp_isLoaded;
  float    evt_muegcleanfix_pfmetPhi_PhotonEnDown_;
  TBranch *evt_muegcleanfix_pfmetPhi_PhotonEnDown_branch;
  bool     evt_muegcleanfix_pfmetPhi_PhotonEnDown_isLoaded;
  float    evt_muegcleanfix_pfmetPhi_PhotonEnUp_;
  TBranch *evt_muegcleanfix_pfmetPhi_PhotonEnUp_branch;
  bool     evt_muegcleanfix_pfmetPhi_PhotonEnUp_isLoaded;
  float    evt_muegcleanfix_pfmetPhi_TauEnDown_;
  TBranch *evt_muegcleanfix_pfmetPhi_TauEnDown_branch;
  bool     evt_muegcleanfix_pfmetPhi_TauEnDown_isLoaded;
  float    evt_muegcleanfix_pfmetPhi_TauEnUp_;
  TBranch *evt_muegcleanfix_pfmetPhi_TauEnUp_branch;
  bool     evt_muegcleanfix_pfmetPhi_TauEnUp_isLoaded;
  float    evt_muegcleanfix_pfmetPhi_UnclusteredEnDown_;
  TBranch *evt_muegcleanfix_pfmetPhi_UnclusteredEnDown_branch;
  bool     evt_muegcleanfix_pfmetPhi_UnclusteredEnDown_isLoaded;
  float    evt_muegcleanfix_pfmetPhi_UnclusteredEnUp_;
  TBranch *evt_muegcleanfix_pfmetPhi_UnclusteredEnUp_branch;
  bool     evt_muegcleanfix_pfmetPhi_UnclusteredEnUp_isLoaded;
  float    evt_muegcleanfix_pfmetPhi_raw_;
  TBranch *evt_muegcleanfix_pfmetPhi_raw_branch;
  bool     evt_muegcleanfix_pfmetPhi_raw_isLoaded;
  float    evt_muegcleanfix_pfmet_PhotonEnDown_;
  TBranch *evt_muegcleanfix_pfmet_PhotonEnDown_branch;
  bool     evt_muegcleanfix_pfmet_PhotonEnDown_isLoaded;
  float    evt_muegcleanfix_pfmet_PhotonEnUp_;
  TBranch *evt_muegcleanfix_pfmet_PhotonEnUp_branch;
  bool     evt_muegcleanfix_pfmet_PhotonEnUp_isLoaded;
  float    evt_muegcleanfix_pfmetSig_;
  TBranch *evt_muegcleanfix_pfmetSig_branch;
  bool     evt_muegcleanfix_pfmetSig_isLoaded;
  float    evt_muegcleanfix_pfmetSignificance_;
  TBranch *evt_muegcleanfix_pfmetSignificance_branch;
  bool     evt_muegcleanfix_pfmetSignificance_isLoaded;
  float    evt_muegcleanfix_pfmet_TauEnDown_;
  TBranch *evt_muegcleanfix_pfmet_TauEnDown_branch;
  bool     evt_muegcleanfix_pfmet_TauEnDown_isLoaded;
  float    evt_muegcleanfix_pfmet_TauEnUp_;
  TBranch *evt_muegcleanfix_pfmet_TauEnUp_branch;
  bool     evt_muegcleanfix_pfmet_TauEnUp_isLoaded;
  float    evt_muegcleanfix_pfmet_UnclusteredEnDown_;
  TBranch *evt_muegcleanfix_pfmet_UnclusteredEnDown_branch;
  bool     evt_muegcleanfix_pfmet_UnclusteredEnDown_isLoaded;
  float    evt_muegcleanfix_pfmet_UnclusteredEnUp_;
  TBranch *evt_muegcleanfix_pfmet_UnclusteredEnUp_branch;
  bool     evt_muegcleanfix_pfmet_UnclusteredEnUp_isLoaded;
  float    evt_muegcleanfix_pfmet_raw_;
  TBranch *evt_muegcleanfix_pfmet_raw_branch;
  bool     evt_muegcleanfix_pfmet_raw_isLoaded;
  float    evt_muegcleanfix_pfsumet_;
  TBranch *evt_muegcleanfix_pfsumet_branch;
  bool     evt_muegcleanfix_pfsumet_isLoaded;
  float    evt_muegcleanfix_pfsumet_raw_;
  TBranch *evt_muegcleanfix_pfsumet_raw_branch;
  bool     evt_muegcleanfix_pfsumet_raw_isLoaded;
  float    evt_uncorr_calomet_;
  TBranch *evt_uncorr_calomet_branch;
  bool     evt_uncorr_calomet_isLoaded;
  float    evt_uncorr_calometPhi_;
  TBranch *evt_uncorr_calometPhi_branch;
  bool     evt_uncorr_calometPhi_isLoaded;
  float    evt_uncorr_pfmet_;
  TBranch *evt_uncorr_pfmet_branch;
  bool     evt_uncorr_pfmet_isLoaded;
  float    evt_uncorr_pfmet_ElectronEnDown_;
  TBranch *evt_uncorr_pfmet_ElectronEnDown_branch;
  bool     evt_uncorr_pfmet_ElectronEnDown_isLoaded;
  float    evt_uncorr_pfmet_ElectronEnUp_;
  TBranch *evt_uncorr_pfmet_ElectronEnUp_branch;
  bool     evt_uncorr_pfmet_ElectronEnUp_isLoaded;
  float    evt_uncorr_pfmet_JetEnDown_;
  TBranch *evt_uncorr_pfmet_JetEnDown_branch;
  bool     evt_uncorr_pfmet_JetEnDown_isLoaded;
  float    evt_uncorr_pfmet_JetEnUp_;
  TBranch *evt_uncorr_pfmet_JetEnUp_branch;
  bool     evt_uncorr_pfmet_JetEnUp_isLoaded;
  float    evt_uncorr_pfmet_JetResDown_;
  TBranch *evt_uncorr_pfmet_JetResDown_branch;
  bool     evt_uncorr_pfmet_JetResDown_isLoaded;
  float    evt_uncorr_pfmet_JetResUp_;
  TBranch *evt_uncorr_pfmet_JetResUp_branch;
  bool     evt_uncorr_pfmet_JetResUp_isLoaded;
  float    evt_uncorr_pfmet_MuonEnDown_;
  TBranch *evt_uncorr_pfmet_MuonEnDown_branch;
  bool     evt_uncorr_pfmet_MuonEnDown_isLoaded;
  float    evt_uncorr_pfmet_MuonEnUp_;
  TBranch *evt_uncorr_pfmet_MuonEnUp_branch;
  bool     evt_uncorr_pfmet_MuonEnUp_isLoaded;
  float    evt_uncorr_pfmetPhi_;
  TBranch *evt_uncorr_pfmetPhi_branch;
  bool     evt_uncorr_pfmetPhi_isLoaded;
  float    evt_uncorr_pfmetPhi_ElectronEnDown_;
  TBranch *evt_uncorr_pfmetPhi_ElectronEnDown_branch;
  bool     evt_uncorr_pfmetPhi_ElectronEnDown_isLoaded;
  float    evt_uncorr_pfmetPhi_ElectronEnUp_;
  TBranch *evt_uncorr_pfmetPhi_ElectronEnUp_branch;
  bool     evt_uncorr_pfmetPhi_ElectronEnUp_isLoaded;
  float    evt_uncorr_pfmetPhi_JetEnDown_;
  TBranch *evt_uncorr_pfmetPhi_JetEnDown_branch;
  bool     evt_uncorr_pfmetPhi_JetEnDown_isLoaded;
  float    evt_uncorr_pfmetPhi_JetEnUp_;
  TBranch *evt_uncorr_pfmetPhi_JetEnUp_branch;
  bool     evt_uncorr_pfmetPhi_JetEnUp_isLoaded;
  float    evt_uncorr_pfmetPhi_JetResDown_;
  TBranch *evt_uncorr_pfmetPhi_JetResDown_branch;
  bool     evt_uncorr_pfmetPhi_JetResDown_isLoaded;
  float    evt_uncorr_pfmetPhi_JetResUp_;
  TBranch *evt_uncorr_pfmetPhi_JetResUp_branch;
  bool     evt_uncorr_pfmetPhi_JetResUp_isLoaded;
  float    evt_uncorr_pfmetPhi_MuonEnDown_;
  TBranch *evt_uncorr_pfmetPhi_MuonEnDown_branch;
  bool     evt_uncorr_pfmetPhi_MuonEnDown_isLoaded;
  float    evt_uncorr_pfmetPhi_MuonEnUp_;
  TBranch *evt_uncorr_pfmetPhi_MuonEnUp_branch;
  bool     evt_uncorr_pfmetPhi_MuonEnUp_isLoaded;
  float    evt_uncorr_pfmetPhi_PhotonEnDown_;
  TBranch *evt_uncorr_pfmetPhi_PhotonEnDown_branch;
  bool     evt_uncorr_pfmetPhi_PhotonEnDown_isLoaded;
  float    evt_uncorr_pfmetPhi_PhotonEnUp_;
  TBranch *evt_uncorr_pfmetPhi_PhotonEnUp_branch;
  bool     evt_uncorr_pfmetPhi_PhotonEnUp_isLoaded;
  float    evt_uncorr_pfmetPhi_TauEnDown_;
  TBranch *evt_uncorr_pfmetPhi_TauEnDown_branch;
  bool     evt_uncorr_pfmetPhi_TauEnDown_isLoaded;
  float    evt_uncorr_pfmetPhi_TauEnUp_;
  TBranch *evt_uncorr_pfmetPhi_TauEnUp_branch;
  bool     evt_uncorr_pfmetPhi_TauEnUp_isLoaded;
  float    evt_uncorr_pfmetPhi_UnclusteredEnDown_;
  TBranch *evt_uncorr_pfmetPhi_UnclusteredEnDown_branch;
  bool     evt_uncorr_pfmetPhi_UnclusteredEnDown_isLoaded;
  float    evt_uncorr_pfmetPhi_UnclusteredEnUp_;
  TBranch *evt_uncorr_pfmetPhi_UnclusteredEnUp_branch;
  bool     evt_uncorr_pfmetPhi_UnclusteredEnUp_isLoaded;
  float    evt_uncorr_pfmetPhi_raw_;
  TBranch *evt_uncorr_pfmetPhi_raw_branch;
  bool     evt_uncorr_pfmetPhi_raw_isLoaded;
  float    evt_uncorr_pfmet_PhotonEnDown_;
  TBranch *evt_uncorr_pfmet_PhotonEnDown_branch;
  bool     evt_uncorr_pfmet_PhotonEnDown_isLoaded;
  float    evt_uncorr_pfmet_PhotonEnUp_;
  TBranch *evt_uncorr_pfmet_PhotonEnUp_branch;
  bool     evt_uncorr_pfmet_PhotonEnUp_isLoaded;
  float    evt_uncorr_pfmetSig_;
  TBranch *evt_uncorr_pfmetSig_branch;
  bool     evt_uncorr_pfmetSig_isLoaded;
  float    evt_uncorr_pfmetSignificance_;
  TBranch *evt_uncorr_pfmetSignificance_branch;
  bool     evt_uncorr_pfmetSignificance_isLoaded;
  float    evt_uncorr_pfmet_TauEnDown_;
  TBranch *evt_uncorr_pfmet_TauEnDown_branch;
  bool     evt_uncorr_pfmet_TauEnDown_isLoaded;
  float    evt_uncorr_pfmet_TauEnUp_;
  TBranch *evt_uncorr_pfmet_TauEnUp_branch;
  bool     evt_uncorr_pfmet_TauEnUp_isLoaded;
  float    evt_uncorr_pfmet_UnclusteredEnDown_;
  TBranch *evt_uncorr_pfmet_UnclusteredEnDown_branch;
  bool     evt_uncorr_pfmet_UnclusteredEnDown_isLoaded;
  float    evt_uncorr_pfmet_UnclusteredEnUp_;
  TBranch *evt_uncorr_pfmet_UnclusteredEnUp_branch;
  bool     evt_uncorr_pfmet_UnclusteredEnUp_isLoaded;
  float    evt_uncorr_pfmet_raw_;
  TBranch *evt_uncorr_pfmet_raw_branch;
  bool     evt_uncorr_pfmet_raw_isLoaded;
  float    evt_uncorr_pfsumet_;
  TBranch *evt_uncorr_pfsumet_branch;
  bool     evt_uncorr_pfsumet_isLoaded;
  float    evt_uncorr_pfsumet_raw_;
  TBranch *evt_uncorr_pfsumet_raw_branch;
  bool     evt_uncorr_pfsumet_raw_isLoaded;
  ...
  vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > elsBeforeGSFix_mc_patMatch_p4_;
  TBranch *elsBeforeGSFix_mc_patMatch_p4_branch;
  bool     elsBeforeGSFix_mc_patMatch_p4_isLoaded;
  vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > elsBeforeGSFix_p4_;
  TBranch *elsBeforeGSFix_p4_branch;
  bool     elsBeforeGSFix_p4_isLoaded;
  vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > elsBeforeGSFix_p4In_;
  TBranch *elsBeforeGSFix_p4In_branch;
  bool     elsBeforeGSFix_p4In_isLoaded;
  vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > elsBeforeGSFix_p4Out_;
  TBranch *elsBeforeGSFix_p4Out_branch;
  bool     elsBeforeGSFix_p4Out_isLoaded;
  vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > elsBeforeGSFix_trk_p4_;
  TBranch *elsBeforeGSFix_trk_p4_branch;
  bool     elsBeforeGSFix_trk_p4_isLoaded;
  vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > elsBeforeGSFix_trk_vertex_p4_;
  TBranch *elsBeforeGSFix_trk_vertex_p4_branch;
  bool     elsBeforeGSFix_trk_vertex_p4_isLoaded;
  vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > elsBeforeGSFix_vertex_p4_;
  TBranch *elsBeforeGSFix_vertex_p4_branch;
  bool     elsBeforeGSFix_vertex_p4_isLoaded;
  ...
  vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > pfcandsdiscard_p4_;
  TBranch *pfcandsdiscard_p4_branch;
  bool     pfcandsdiscard_p4_isLoaded;
  ...
  vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > photonsBeforeGSFix_p4_;
  TBranch *photonsBeforeGSFix_p4_branch;
  bool     photonsBeforeGSFix_p4_isLoaded;
  ...
  vector<float> elsBeforeGSFix_bs2d_;
  TBranch *elsBeforeGSFix_bs2d_branch;
  bool     elsBeforeGSFix_bs2d_isLoaded;
  vector<float> elsBeforeGSFix_bs2derr_;
  TBranch *elsBeforeGSFix_bs2derr_branch;
  bool     elsBeforeGSFix_bs2derr_isLoaded;
  vector<float> elsBeforeGSFix_bs3d_;
  TBranch *elsBeforeGSFix_bs3d_branch;
  bool     elsBeforeGSFix_bs3d_isLoaded;
  vector<float> elsBeforeGSFix_bs3derr_;
  TBranch *elsBeforeGSFix_bs3derr_branch;
  bool     elsBeforeGSFix_bs3derr_isLoaded;
  vector<float> elsBeforeGSFix_chi2_;
  TBranch *elsBeforeGSFix_chi2_branch;
  bool     elsBeforeGSFix_chi2_isLoaded;
  vector<float> elsBeforeGSFix_ckf_chi2_;
  TBranch *elsBeforeGSFix_ckf_chi2_branch;
  bool     elsBeforeGSFix_ckf_chi2_isLoaded;
  vector<float> elsBeforeGSFix_ckf_ndof_;
  TBranch *elsBeforeGSFix_ckf_ndof_branch;
  bool     elsBeforeGSFix_ckf_ndof_isLoaded;
  vector<float> elsBeforeGSFix_clusterMaxDR_;
  TBranch *elsBeforeGSFix_clusterMaxDR_branch;
  bool     elsBeforeGSFix_clusterMaxDR_isLoaded;
  vector<float> elsBeforeGSFix_clusterMaxDRDEta_;
  TBranch *elsBeforeGSFix_clusterMaxDRDEta_branch;
  bool     elsBeforeGSFix_clusterMaxDRDEta_isLoaded;
  vector<float> elsBeforeGSFix_clusterMaxDRDPhi_;
  TBranch *elsBeforeGSFix_clusterMaxDRDPhi_branch;
  bool     elsBeforeGSFix_clusterMaxDRDPhi_isLoaded;
  vector<float> elsBeforeGSFix_clusterMaxDRRawEnergy_;
  TBranch *elsBeforeGSFix_clusterMaxDRRawEnergy_branch;
  bool     elsBeforeGSFix_clusterMaxDRRawEnergy_isLoaded;
  vector<float> elsBeforeGSFix_clustersMeanDEtaToSeed_;
  TBranch *elsBeforeGSFix_clustersMeanDEtaToSeed_branch;
  bool     elsBeforeGSFix_clustersMeanDEtaToSeed_isLoaded;
  vector<float> elsBeforeGSFix_clustersMeanDPhiToSeed_;
  TBranch *elsBeforeGSFix_clustersMeanDPhiToSeed_branch;
  bool     elsBeforeGSFix_clustersMeanDPhiToSeed_isLoaded;
  vector<float> elsBeforeGSFix_clustersMeanDRToSeed_;
  TBranch *elsBeforeGSFix_clustersMeanDRToSeed_branch;
  bool     elsBeforeGSFix_clustersMeanDRToSeed_isLoaded;
  vector<float> elsBeforeGSFix_clustersMeanRawEnergy_;
  TBranch *elsBeforeGSFix_clustersMeanRawEnergy_branch;
  bool     elsBeforeGSFix_clustersMeanRawEnergy_isLoaded;
  vector<float> elsBeforeGSFix_clustersRMSRawEnergy_;
  TBranch *elsBeforeGSFix_clustersRMSRawEnergy_branch;
  bool     elsBeforeGSFix_clustersRMSRawEnergy_isLoaded;
  vector<float> elsBeforeGSFix_conv_vtx_prob_;
  TBranch *elsBeforeGSFix_conv_vtx_prob_branch;
  bool     elsBeforeGSFix_conv_vtx_prob_isLoaded;
  vector<float> elsBeforeGSFix_d0_;
  TBranch *elsBeforeGSFix_d0_branch;
  bool     elsBeforeGSFix_d0_isLoaded;
  vector<float> elsBeforeGSFix_d0Err_;
  TBranch *elsBeforeGSFix_d0Err_branch;
  bool     elsBeforeGSFix_d0Err_isLoaded;
  vector<float> elsBeforeGSFix_d0corr_;
  TBranch *elsBeforeGSFix_d0corr_branch;
  bool     elsBeforeGSFix_d0corr_isLoaded;
  vector<float> elsBeforeGSFix_d0corrPhi_;
  TBranch *elsBeforeGSFix_d0corrPhi_branch;
  bool     elsBeforeGSFix_d0corrPhi_isLoaded;
  vector<float> elsBeforeGSFix_d0phiCov_;
  TBranch *elsBeforeGSFix_d0phiCov_branch;
  bool     elsBeforeGSFix_d0phiCov_isLoaded;
  vector<float> elsBeforeGSFix_dEtaIn_;
  TBranch *elsBeforeGSFix_dEtaIn_branch;
  bool     elsBeforeGSFix_dEtaIn_isLoaded;
  vector<float> elsBeforeGSFix_dEtaOut_;
  TBranch *elsBeforeGSFix_dEtaOut_branch;
  bool     elsBeforeGSFix_dEtaOut_isLoaded;
  vector<float> elsBeforeGSFix_dPhiIn_;
  TBranch *elsBeforeGSFix_dPhiIn_branch;
  bool     elsBeforeGSFix_dPhiIn_isLoaded;
  vector<float> elsBeforeGSFix_dPhiInPhiOut_;
  TBranch *elsBeforeGSFix_dPhiInPhiOut_branch;
  bool     elsBeforeGSFix_dPhiInPhiOut_isLoaded;
  vector<float> elsBeforeGSFix_dPhiOut_;
  TBranch *elsBeforeGSFix_dPhiOut_branch;
  bool     elsBeforeGSFix_dPhiOut_isLoaded;
  vector<float> elsBeforeGSFix_deltaEtaEleClusterTrackAtCalo_;
  TBranch *elsBeforeGSFix_deltaEtaEleClusterTrackAtCalo_branch;
  bool     elsBeforeGSFix_deltaEtaEleClusterTrackAtCalo_isLoaded;
  vector<float> elsBeforeGSFix_deltaPhiEleClusterTrackAtCalo_;
  TBranch *elsBeforeGSFix_deltaPhiEleClusterTrackAtCalo_branch;
  bool     elsBeforeGSFix_deltaPhiEleClusterTrackAtCalo_isLoaded;
  vector<float> elsBeforeGSFix_dxyPV_;
  TBranch *elsBeforeGSFix_dxyPV_branch;
  bool     elsBeforeGSFix_dxyPV_isLoaded;
  vector<float> elsBeforeGSFix_dzPV_;
  TBranch *elsBeforeGSFix_dzPV_branch;
  bool     elsBeforeGSFix_dzPV_isLoaded;
  vector<float> elsBeforeGSFix_e1x5_;
  TBranch *elsBeforeGSFix_e1x5_branch;
  bool     elsBeforeGSFix_e1x5_isLoaded;
  vector<float> elsBeforeGSFix_e1x5_full5x5_;
  TBranch *elsBeforeGSFix_e1x5_full5x5_branch;
  bool     elsBeforeGSFix_e1x5_full5x5_isLoaded;
  vector<float> elsBeforeGSFix_e2x5Max_;
  TBranch *elsBeforeGSFix_e2x5Max_branch;
  bool     elsBeforeGSFix_e2x5Max_isLoaded;
  vector<float> elsBeforeGSFix_e2x5Max_full5x5_;
  TBranch *elsBeforeGSFix_e2x5Max_full5x5_branch;
  bool     elsBeforeGSFix_e2x5Max_full5x5_isLoaded;
  vector<float> elsBeforeGSFix_e5x5_;
  TBranch *elsBeforeGSFix_e5x5_branch;
  bool     elsBeforeGSFix_e5x5_isLoaded;
  vector<float> elsBeforeGSFix_e5x5_full5x5_;
  TBranch *elsBeforeGSFix_e5x5_full5x5_branch;
  bool     elsBeforeGSFix_e5x5_full5x5_isLoaded;
  vector<float> elsBeforeGSFix_eOverPIn_;
  TBranch *elsBeforeGSFix_eOverPIn_branch;
  bool     elsBeforeGSFix_eOverPIn_isLoaded;
  vector<float> elsBeforeGSFix_eOverPOut_;
  TBranch *elsBeforeGSFix_eOverPOut_branch;
  bool     elsBeforeGSFix_eOverPOut_isLoaded;
  vector<float> elsBeforeGSFix_eSC_;
  TBranch *elsBeforeGSFix_eSC_branch;
  bool     elsBeforeGSFix_eSC_isLoaded;
  vector<float> elsBeforeGSFix_eSCPresh_;
  TBranch *elsBeforeGSFix_eSCPresh_branch;
  bool     elsBeforeGSFix_eSCPresh_isLoaded;
  vector<float> elsBeforeGSFix_eSCRaw_;
  TBranch *elsBeforeGSFix_eSCRaw_branch;
  bool     elsBeforeGSFix_eSCRaw_isLoaded;
  vector<float> elsBeforeGSFix_eSeed_;
  TBranch *elsBeforeGSFix_eSeed_branch;
  bool     elsBeforeGSFix_eSeed_isLoaded;
  vector<float> elsBeforeGSFix_eSeedOverPIn_;
  TBranch *elsBeforeGSFix_eSeedOverPIn_branch;
  bool     elsBeforeGSFix_eSeedOverPIn_isLoaded;
  vector<float> elsBeforeGSFix_eSeedOverPOut_;
  TBranch *elsBeforeGSFix_eSeedOverPOut_branch;
  bool     elsBeforeGSFix_eSeedOverPOut_isLoaded;
  vector<float> elsBeforeGSFix_ecalEnergy_;
  TBranch *elsBeforeGSFix_ecalEnergy_branch;
  bool     elsBeforeGSFix_ecalEnergy_isLoaded;
  vector<float> elsBeforeGSFix_ecalEnergyError_;
  TBranch *elsBeforeGSFix_ecalEnergyError_branch;
  bool     elsBeforeGSFix_ecalEnergyError_isLoaded;
  vector<float> elsBeforeGSFix_ecalIso_;
  TBranch *elsBeforeGSFix_ecalIso_branch;
  bool     elsBeforeGSFix_ecalIso_isLoaded;
  vector<float> elsBeforeGSFix_ecalIso04_;
  TBranch *elsBeforeGSFix_ecalIso04_branch;
  bool     elsBeforeGSFix_ecalIso04_isLoaded;
  vector<float> elsBeforeGSFix_ecalPFClusterIso_;
  TBranch *elsBeforeGSFix_ecalPFClusterIso_branch;
  bool     elsBeforeGSFix_ecalPFClusterIso_isLoaded;
  vector<float> elsBeforeGSFix_etaErr_;
  TBranch *elsBeforeGSFix_etaErr_branch;
  bool     elsBeforeGSFix_etaErr_isLoaded;
  vector<float> elsBeforeGSFix_etaSC_;
  TBranch *elsBeforeGSFix_etaSC_branch;
  bool     elsBeforeGSFix_etaSC_isLoaded;
  vector<float> elsBeforeGSFix_etaSCwidth_;
  TBranch *elsBeforeGSFix_etaSCwidth_branch;
  bool     elsBeforeGSFix_etaSCwidth_isLoaded;
  vector<float> elsBeforeGSFix_fbrem_;
  TBranch *elsBeforeGSFix_fbrem_branch;
  bool     elsBeforeGSFix_fbrem_isLoaded;
  vector<float> elsBeforeGSFix_full5x5_hOverE_;
  TBranch *elsBeforeGSFix_full5x5_hOverE_branch;
  bool     elsBeforeGSFix_full5x5_hOverE_isLoaded;
  vector<float> elsBeforeGSFix_hOverE_;
  TBranch *elsBeforeGSFix_hOverE_branch;
  bool     elsBeforeGSFix_hOverE_isLoaded;
  vector<float> elsBeforeGSFix_hOverEBC_;
  TBranch *elsBeforeGSFix_hOverEBC_branch;
  bool     elsBeforeGSFix_hOverEBC_isLoaded;
  vector<float> elsBeforeGSFix_hcalDepth1OverEcal_;
  TBranch *elsBeforeGSFix_hcalDepth1OverEcal_branch;
  bool     elsBeforeGSFix_hcalDepth1OverEcal_isLoaded;
  vector<float> elsBeforeGSFix_hcalDepth1TowerSumEt_;
  TBranch *elsBeforeGSFix_hcalDepth1TowerSumEt_branch;
  bool     elsBeforeGSFix_hcalDepth1TowerSumEt_isLoaded;
  vector<float> elsBeforeGSFix_hcalDepth1TowerSumEt04_;
  TBranch *elsBeforeGSFix_hcalDepth1TowerSumEt04_branch;
  bool     elsBeforeGSFix_hcalDepth1TowerSumEt04_isLoaded;
  vector<float> elsBeforeGSFix_hcalDepth2OverEcal_;
  TBranch *elsBeforeGSFix_hcalDepth2OverEcal_branch;
  bool     elsBeforeGSFix_hcalDepth2OverEcal_isLoaded;
  vector<float> elsBeforeGSFix_hcalDepth2TowerSumEt_;
  TBranch *elsBeforeGSFix_hcalDepth2TowerSumEt_branch;
  bool     elsBeforeGSFix_hcalDepth2TowerSumEt_isLoaded;
  vector<float> elsBeforeGSFix_hcalDepth2TowerSumEt04_;
  TBranch *elsBeforeGSFix_hcalDepth2TowerSumEt04_branch;
  bool     elsBeforeGSFix_hcalDepth2TowerSumEt04_isLoaded;
  vector<float> elsBeforeGSFix_hcalIso_;
  TBranch *elsBeforeGSFix_hcalIso_branch;
  bool     elsBeforeGSFix_hcalIso_isLoaded;
  vector<float> elsBeforeGSFix_hcalIso04_;
  TBranch *elsBeforeGSFix_hcalIso04_branch;
  bool     elsBeforeGSFix_hcalIso04_isLoaded;
  vector<float> elsBeforeGSFix_hcalPFClusterIso_;
  TBranch *elsBeforeGSFix_hcalPFClusterIso_branch;
  bool     elsBeforeGSFix_hcalPFClusterIso_isLoaded;
  vector<float> elsBeforeGSFix_ip2d_;
  TBranch *elsBeforeGSFix_ip2d_branch;
  bool     elsBeforeGSFix_ip2d_isLoaded;
  vector<float> elsBeforeGSFix_ip2derr_;
  TBranch *elsBeforeGSFix_ip2derr_branch;
  bool     elsBeforeGSFix_ip2derr_isLoaded;
  vector<float> elsBeforeGSFix_ip3d_;
  TBranch *elsBeforeGSFix_ip3d_branch;
  bool     elsBeforeGSFix_ip3d_isLoaded;
  vector<float> elsBeforeGSFix_ip3derr_;
  TBranch *elsBeforeGSFix_ip3derr_branch;
  bool     elsBeforeGSFix_ip3derr_isLoaded;
  vector<float> elsBeforeGSFix_mass_;
  TBranch *elsBeforeGSFix_mass_branch;
  bool     elsBeforeGSFix_mass_isLoaded;
  vector<float> elsBeforeGSFix_mc_patMatch_dr_;
  TBranch *elsBeforeGSFix_mc_patMatch_dr_branch;
  bool     elsBeforeGSFix_mc_patMatch_dr_isLoaded;
  vector<float> elsBeforeGSFix_miniIso_ch_;
  TBranch *elsBeforeGSFix_miniIso_ch_branch;
  bool     elsBeforeGSFix_miniIso_ch_isLoaded;
  vector<float> elsBeforeGSFix_miniIso_db_;
  TBranch *elsBeforeGSFix_miniIso_db_branch;
  bool     elsBeforeGSFix_miniIso_db_isLoaded;
  vector<float> elsBeforeGSFix_miniIso_em_;
  TBranch *elsBeforeGSFix_miniIso_em_branch;
  bool     elsBeforeGSFix_miniIso_em_isLoaded;
  vector<float> elsBeforeGSFix_miniIso_nh_;
  TBranch *elsBeforeGSFix_miniIso_nh_branch;
  bool     elsBeforeGSFix_miniIso_nh_isLoaded;
  vector<float> elsBeforeGSFix_miniIso_uncor_;
  TBranch *elsBeforeGSFix_miniIso_uncor_branch;
  bool     elsBeforeGSFix_miniIso_uncor_isLoaded;
  vector<float> elsBeforeGSFix_mva_;
  TBranch *elsBeforeGSFix_mva_branch;
  bool     elsBeforeGSFix_mva_isLoaded;
  vector<float> elsBeforeGSFix_ndof_;
  TBranch *elsBeforeGSFix_ndof_branch;
  bool     elsBeforeGSFix_ndof_isLoaded;
  vector<float> elsBeforeGSFix_pfChargedHadronIso_;
  TBranch *elsBeforeGSFix_pfChargedHadronIso_branch;
  bool     elsBeforeGSFix_pfChargedHadronIso_isLoaded;
  vector<float> elsBeforeGSFix_pfNeutralHadronIso_;
  TBranch *elsBeforeGSFix_pfNeutralHadronIso_branch;
  bool     elsBeforeGSFix_pfNeutralHadronIso_isLoaded;
  vector<float> elsBeforeGSFix_pfPUIso_;
  TBranch *elsBeforeGSFix_pfPUIso_branch;
  bool     elsBeforeGSFix_pfPUIso_isLoaded;
  vector<float> elsBeforeGSFix_pfPhotonIso_;
  TBranch *elsBeforeGSFix_pfPhotonIso_branch;
  bool     elsBeforeGSFix_pfPhotonIso_isLoaded;
  vector<float> elsBeforeGSFix_phiErr_;
  TBranch *elsBeforeGSFix_phiErr_branch;
  bool     elsBeforeGSFix_phiErr_isLoaded;
  vector<float> elsBeforeGSFix_phiSC_;
  TBranch *elsBeforeGSFix_phiSC_branch;
  bool     elsBeforeGSFix_phiSC_isLoaded;
  vector<float> elsBeforeGSFix_phiSCwidth_;
  TBranch *elsBeforeGSFix_phiSCwidth_branch;
  bool     elsBeforeGSFix_phiSCwidth_isLoaded;
  vector<float> elsBeforeGSFix_ptErr_;
  TBranch *elsBeforeGSFix_ptErr_branch;
  bool     elsBeforeGSFix_ptErr_isLoaded;
  vector<float> elsBeforeGSFix_ptErrGsf_;
  TBranch *elsBeforeGSFix_ptErrGsf_branch;
  bool     elsBeforeGSFix_ptErrGsf_isLoaded;
  vector<float> elsBeforeGSFix_r9_;
  TBranch *elsBeforeGSFix_r9_branch;
  bool     elsBeforeGSFix_r9_isLoaded;
  vector<float> elsBeforeGSFix_r9_full5x5_;
  TBranch *elsBeforeGSFix_r9_full5x5_branch;
  bool     elsBeforeGSFix_r9_full5x5_isLoaded;
  vector<float> elsBeforeGSFix_scIsEB_;
  TBranch *elsBeforeGSFix_scIsEB_branch;
  bool     elsBeforeGSFix_scIsEB_isLoaded;
  vector<float> elsBeforeGSFix_scPreshowerEnergyPlane1_;
  TBranch *elsBeforeGSFix_scPreshowerEnergyPlane1_branch;
  bool     elsBeforeGSFix_scPreshowerEnergyPlane1_isLoaded;
  vector<float> elsBeforeGSFix_scPreshowerEnergyPlane2_;
  TBranch *elsBeforeGSFix_scPreshowerEnergyPlane2_branch;
  bool     elsBeforeGSFix_scPreshowerEnergyPlane2_isLoaded;
  vector<float> elsBeforeGSFix_scR_;
  TBranch *elsBeforeGSFix_scR_branch;
  bool     elsBeforeGSFix_scR_isLoaded;
  vector<float> elsBeforeGSFix_scSeed2x5LeftRightAsym_;
  TBranch *elsBeforeGSFix_scSeed2x5LeftRightAsym_branch;
  bool     elsBeforeGSFix_scSeed2x5LeftRightAsym_isLoaded;
  vector<float> elsBeforeGSFix_scSeed2x5TopBottomAsym_;
  TBranch *elsBeforeGSFix_scSeed2x5TopBottomAsym_branch;
  bool     elsBeforeGSFix_scSeed2x5TopBottomAsym_isLoaded;
  vector<float> elsBeforeGSFix_scSeedCryEta_;
  TBranch *elsBeforeGSFix_scSeedCryEta_branch;
  bool     elsBeforeGSFix_scSeedCryEta_isLoaded;
  vector<float> elsBeforeGSFix_scSeedCryIeta_;
  TBranch *elsBeforeGSFix_scSeedCryIeta_branch;
  bool     elsBeforeGSFix_scSeedCryIeta_isLoaded;
  vector<float> elsBeforeGSFix_scSeedCryIphi_;
  TBranch *elsBeforeGSFix_scSeedCryIphi_branch;
  bool     elsBeforeGSFix_scSeedCryIphi_isLoaded;
  vector<float> elsBeforeGSFix_scSeedCryIx_;
  TBranch *elsBeforeGSFix_scSeedCryIx_branch;
  bool     elsBeforeGSFix_scSeedCryIx_isLoaded;
  vector<float> elsBeforeGSFix_scSeedCryIy_;
  TBranch *elsBeforeGSFix_scSeedCryIy_branch;
  bool     elsBeforeGSFix_scSeedCryIy_isLoaded;
  vector<float> elsBeforeGSFix_scSeedCryPhi_;
  TBranch *elsBeforeGSFix_scSeedCryPhi_branch;
  bool     elsBeforeGSFix_scSeedCryPhi_isLoaded;
  vector<float> elsBeforeGSFix_scSeedCryX_;
  TBranch *elsBeforeGSFix_scSeedCryX_branch;
  bool     elsBeforeGSFix_scSeedCryX_isLoaded;
  vector<float> elsBeforeGSFix_scSeedCryY_;
  TBranch *elsBeforeGSFix_scSeedCryY_branch;
  bool     elsBeforeGSFix_scSeedCryY_isLoaded;
  vector<float> elsBeforeGSFix_scSeedE2nd_;
  TBranch *elsBeforeGSFix_scSeedE2nd_branch;
  bool     elsBeforeGSFix_scSeedE2nd_isLoaded;
  vector<float> elsBeforeGSFix_scSeedE2x5Bottom_;
  TBranch *elsBeforeGSFix_scSeedE2x5Bottom_branch;
  bool     elsBeforeGSFix_scSeedE2x5Bottom_isLoaded;
  vector<float> elsBeforeGSFix_scSeedE2x5Left_;
  TBranch *elsBeforeGSFix_scSeedE2x5Left_branch;
  bool     elsBeforeGSFix_scSeedE2x5Left_isLoaded;
  vector<float> elsBeforeGSFix_scSeedE2x5Right_;
  TBranch *elsBeforeGSFix_scSeedE2x5Right_branch;
  bool     elsBeforeGSFix_scSeedE2x5Right_isLoaded;
  vector<float> elsBeforeGSFix_scSeedE2x5Top_;
  TBranch *elsBeforeGSFix_scSeedE2x5Top_branch;
  bool     elsBeforeGSFix_scSeedE2x5Top_isLoaded;
  vector<float> elsBeforeGSFix_scSeedE3x3_;
  TBranch *elsBeforeGSFix_scSeedE3x3_branch;
  bool     elsBeforeGSFix_scSeedE3x3_isLoaded;
  vector<float> elsBeforeGSFix_scSeedEBottom_;
  TBranch *elsBeforeGSFix_scSeedEBottom_branch;
  bool     elsBeforeGSFix_scSeedEBottom_isLoaded;
  vector<float> elsBeforeGSFix_scSeedELeft_;
  TBranch *elsBeforeGSFix_scSeedELeft_branch;
  bool     elsBeforeGSFix_scSeedELeft_isLoaded;
  vector<float> elsBeforeGSFix_scSeedERight_;
  TBranch *elsBeforeGSFix_scSeedERight_branch;
  bool     elsBeforeGSFix_scSeedERight_isLoaded;
  vector<float> elsBeforeGSFix_scSeedETop_;
  TBranch *elsBeforeGSFix_scSeedETop_branch;
  bool     elsBeforeGSFix_scSeedETop_isLoaded;
  vector<float> elsBeforeGSFix_scSeedEmax_;
  TBranch *elsBeforeGSFix_scSeedEmax_branch;
  bool     elsBeforeGSFix_scSeedEmax_isLoaded;
  vector<float> elsBeforeGSFix_scSeedEta_;
  TBranch *elsBeforeGSFix_scSeedEta_branch;
  bool     elsBeforeGSFix_scSeedEta_isLoaded;
  vector<float> elsBeforeGSFix_scSeedLeftRightAsym_;
  TBranch *elsBeforeGSFix_scSeedLeftRightAsym_branch;
  bool     elsBeforeGSFix_scSeedLeftRightAsym_isLoaded;
  vector<float> elsBeforeGSFix_scSeedPhi_;
  TBranch *elsBeforeGSFix_scSeedPhi_branch;
  bool     elsBeforeGSFix_scSeedPhi_isLoaded;
  vector<float> elsBeforeGSFix_scSeedSigmaIetaIphi_;
  TBranch *elsBeforeGSFix_scSeedSigmaIetaIphi_branch;
  bool     elsBeforeGSFix_scSeedSigmaIetaIphi_isLoaded;
  vector<float> elsBeforeGSFix_scSeedSize_;
  TBranch *elsBeforeGSFix_scSeedSize_branch;
  bool     elsBeforeGSFix_scSeedSize_isLoaded;
  vector<float> elsBeforeGSFix_scSeedTopBottomAsym_;
  TBranch *elsBeforeGSFix_scSeedTopBottomAsym_branch;
  bool     elsBeforeGSFix_scSeedTopBottomAsym_isLoaded;
  vector<float> elsBeforeGSFix_sigmaEtaEta_;
  TBranch *elsBeforeGSFix_sigmaEtaEta_branch;
  bool     elsBeforeGSFix_sigmaEtaEta_isLoaded;
  vector<float> elsBeforeGSFix_sigmaEtaEta_full5x5_;
  TBranch *elsBeforeGSFix_sigmaEtaEta_full5x5_branch;
  bool     elsBeforeGSFix_sigmaEtaEta_full5x5_isLoaded;
  vector<float> elsBeforeGSFix_sigmaIEtaIEta_;
  TBranch *elsBeforeGSFix_sigmaIEtaIEta_branch;
  bool     elsBeforeGSFix_sigmaIEtaIEta_isLoaded;
  vector<float> elsBeforeGSFix_sigmaIEtaIEta_full5x5_;
  TBranch *elsBeforeGSFix_sigmaIEtaIEta_full5x5_branch;
  bool     elsBeforeGSFix_sigmaIEtaIEta_full5x5_isLoaded;
  vector<float> elsBeforeGSFix_sigmaIPhiIPhi_;
  TBranch *elsBeforeGSFix_sigmaIPhiIPhi_branch;
  bool     elsBeforeGSFix_sigmaIPhiIPhi_isLoaded;
  vector<float> elsBeforeGSFix_sigmaIPhiIPhi_full5x5_;
  TBranch *elsBeforeGSFix_sigmaIPhiIPhi_full5x5_branch;
  bool     elsBeforeGSFix_sigmaIPhiIPhi_full5x5_isLoaded;
  vector<float> elsBeforeGSFix_tkIso_;
  TBranch *elsBeforeGSFix_tkIso_branch;
  bool     elsBeforeGSFix_tkIso_isLoaded;
  vector<float> elsBeforeGSFix_tkIso04_;
  TBranch *elsBeforeGSFix_tkIso04_branch;
  bool     elsBeforeGSFix_tkIso04_isLoaded;
  vector<float> elsBeforeGSFix_trackMomentumError_;
  TBranch *elsBeforeGSFix_trackMomentumError_branch;
  bool     elsBeforeGSFix_trackMomentumError_isLoaded;
  vector<float> elsBeforeGSFix_trkdr_;
  TBranch *elsBeforeGSFix_trkdr_branch;
  bool     elsBeforeGSFix_trkdr_isLoaded;
  vector<float> elsBeforeGSFix_trkshFrac_;
  TBranch *elsBeforeGSFix_trkshFrac_branch;
  bool     elsBeforeGSFix_trkshFrac_isLoaded;
  vector<float> elsBeforeGSFix_z0_;
  TBranch *elsBeforeGSFix_z0_branch;
  bool     elsBeforeGSFix_z0_isLoaded;
  vector<float> elsBeforeGSFix_z0Err_;
  TBranch *elsBeforeGSFix_z0Err_branch;
  bool     elsBeforeGSFix_z0Err_isLoaded;
  vector<float> elsBeforeGSFix_z0corr_;
  TBranch *elsBeforeGSFix_z0corr_branch;
  bool     elsBeforeGSFix_z0corr_isLoaded;
  ...
  vector<float> pfcandsdiscard_dz_;
  TBranch *pfcandsdiscard_dz_branch;
  bool     pfcandsdiscard_dz_isLoaded;
  vector<float> pfcandsdiscard_dzAssociatedPV_;
  TBranch *pfcandsdiscard_dzAssociatedPV_branch;
  bool     pfcandsdiscard_dzAssociatedPV_isLoaded;
  vector<float> pfcandsdiscard_hcalFraction_;
  TBranch *pfcandsdiscard_hcalFraction_branch;
  bool     pfcandsdiscard_hcalFraction_isLoaded;
  vector<float> pfcandsdiscard_mass_;
  TBranch *pfcandsdiscard_mass_branch;
  bool     pfcandsdiscard_mass_isLoaded;
  vector<float> pfcandsdiscard_puppiWeight_;
  TBranch *pfcandsdiscard_puppiWeight_branch;
  bool     pfcandsdiscard_puppiWeight_isLoaded;
  vector<float> pfcandsdiscard_puppiWeightNoLep_;
  TBranch *pfcandsdiscard_puppiWeightNoLep_branch;
  bool     pfcandsdiscard_puppiWeightNoLep_isLoaded;
  ...
  vector<float> pfcands_hcalFraction_;
  TBranch *pfcands_hcalFraction_branch;
  bool     pfcands_hcalFraction_isLoaded;
  ...
  vector<float> pfjets_deepFlavourJetTagsProbb_;
  TBranch *pfjets_deepFlavourJetTagsProbb_branch;
  bool     pfjets_deepFlavourJetTagsProbb_isLoaded;
  vector<float> pfjets_deepFlavourJetTagsProbbb_;
  TBranch *pfjets_deepFlavourJetTagsProbbb_branch;
  bool     pfjets_deepFlavourJetTagsProbbb_isLoaded;
  vector<float> pfjets_deepFlavourJetTagsProbc_;
  TBranch *pfjets_deepFlavourJetTagsProbc_branch;
  bool     pfjets_deepFlavourJetTagsProbc_isLoaded;
  vector<float> pfjets_deepFlavourJetTagsProbcc_;
  TBranch *pfjets_deepFlavourJetTagsProbcc_branch;
  bool     pfjets_deepFlavourJetTagsProbcc_isLoaded;
  vector<float> pfjets_deepFlavourJetTagsProbudsg_;
  TBranch *pfjets_deepFlavourJetTagsProbudsg_branch;
  bool     pfjets_deepFlavourJetTagsProbudsg_isLoaded;
  ...
  vector<float> pfjets_puppi_deepFlavourJetTagsProbb_;
  TBranch *pfjets_puppi_deepFlavourJetTagsProbb_branch;
  bool     pfjets_puppi_deepFlavourJetTagsProbb_isLoaded;
  vector<float> pfjets_puppi_deepFlavourJetTagsProbbb_;
  TBranch *pfjets_puppi_deepFlavourJetTagsProbbb_branch;
  bool     pfjets_puppi_deepFlavourJetTagsProbbb_isLoaded;
  vector<float> pfjets_puppi_deepFlavourJetTagsProbc_;
  TBranch *pfjets_puppi_deepFlavourJetTagsProbc_branch;
  bool     pfjets_puppi_deepFlavourJetTagsProbc_isLoaded;
  vector<float> pfjets_puppi_deepFlavourJetTagsProbcc_;
  TBranch *pfjets_puppi_deepFlavourJetTagsProbcc_branch;
  bool     pfjets_puppi_deepFlavourJetTagsProbcc_isLoaded;
  vector<float> pfjets_puppi_deepFlavourJetTagsProbudsg_;
  TBranch *pfjets_puppi_deepFlavourJetTagsProbudsg_branch;
  bool     pfjets_puppi_deepFlavourJetTagsProbudsg_isLoaded;
  ...
  vector<float> photonsBeforeGSFix_chargedHadronIso_;
  TBranch *photonsBeforeGSFix_chargedHadronIso_branch;
  bool     photonsBeforeGSFix_chargedHadronIso_isLoaded;
  vector<float> photonsBeforeGSFix_clusterMaxDR_;
  TBranch *photonsBeforeGSFix_clusterMaxDR_branch;
  bool     photonsBeforeGSFix_clusterMaxDR_isLoaded;
  vector<float> photonsBeforeGSFix_clusterMaxDRDEta_;
  TBranch *photonsBeforeGSFix_clusterMaxDRDEta_branch;
  bool     photonsBeforeGSFix_clusterMaxDRDEta_isLoaded;
  vector<float> photonsBeforeGSFix_clusterMaxDRDPhi_;
  TBranch *photonsBeforeGSFix_clusterMaxDRDPhi_branch;
  bool     photonsBeforeGSFix_clusterMaxDRDPhi_isLoaded;
  vector<float> photonsBeforeGSFix_clusterMaxDRRawEnergy_;
  TBranch *photonsBeforeGSFix_clusterMaxDRRawEnergy_branch;
  bool     photonsBeforeGSFix_clusterMaxDRRawEnergy_isLoaded;
  vector<float> photonsBeforeGSFix_clustersMeanDEtaToSeed_;
  TBranch *photonsBeforeGSFix_clustersMeanDEtaToSeed_branch;
  bool     photonsBeforeGSFix_clustersMeanDEtaToSeed_isLoaded;
  vector<float> photonsBeforeGSFix_clustersMeanDPhiToSeed_;
  TBranch *photonsBeforeGSFix_clustersMeanDPhiToSeed_branch;
  bool     photonsBeforeGSFix_clustersMeanDPhiToSeed_isLoaded;
  vector<float> photonsBeforeGSFix_clustersMeanDRToSeed_;
  TBranch *photonsBeforeGSFix_clustersMeanDRToSeed_branch;
  bool     photonsBeforeGSFix_clustersMeanDRToSeed_isLoaded;
  vector<float> photonsBeforeGSFix_clustersMeanRawEnergy_;
  TBranch *photonsBeforeGSFix_clustersMeanRawEnergy_branch;
  bool     photonsBeforeGSFix_clustersMeanRawEnergy_isLoaded;
  vector<float> photonsBeforeGSFix_clustersRMSRawEnergy_;
  TBranch *photonsBeforeGSFix_clustersRMSRawEnergy_branch;
  bool     photonsBeforeGSFix_clustersRMSRawEnergy_isLoaded;
  vector<float> photonsBeforeGSFix_e1x5_;
  TBranch *photonsBeforeGSFix_e1x5_branch;
  bool     photonsBeforeGSFix_e1x5_isLoaded;
  vector<float> photonsBeforeGSFix_e2x5Max_;
  TBranch *photonsBeforeGSFix_e2x5Max_branch;
  bool     photonsBeforeGSFix_e2x5Max_isLoaded;
  vector<float> photonsBeforeGSFix_e3x3_;
  TBranch *photonsBeforeGSFix_e3x3_branch;
  bool     photonsBeforeGSFix_e3x3_isLoaded;
  vector<float> photonsBeforeGSFix_e5x5_;
  TBranch *photonsBeforeGSFix_e5x5_branch;
  bool     photonsBeforeGSFix_e5x5_isLoaded;
  vector<float> photonsBeforeGSFix_eSC_;
  TBranch *photonsBeforeGSFix_eSC_branch;
  bool     photonsBeforeGSFix_eSC_isLoaded;
  vector<float> photonsBeforeGSFix_eSCPresh_;
  TBranch *photonsBeforeGSFix_eSCPresh_branch;
  bool     photonsBeforeGSFix_eSCPresh_isLoaded;
  vector<float> photonsBeforeGSFix_eSCRaw_;
  TBranch *photonsBeforeGSFix_eSCRaw_branch;
  bool     photonsBeforeGSFix_eSCRaw_isLoaded;
  vector<float> photonsBeforeGSFix_ecalIso03_;
  TBranch *photonsBeforeGSFix_ecalIso03_branch;
  bool     photonsBeforeGSFix_ecalIso03_isLoaded;
  vector<float> photonsBeforeGSFix_ecalIso04_;
  TBranch *photonsBeforeGSFix_ecalIso04_branch;
  bool     photonsBeforeGSFix_ecalIso04_isLoaded;
  vector<float> photonsBeforeGSFix_ecalPFClusterIso_;
  TBranch *photonsBeforeGSFix_ecalPFClusterIso_branch;
  bool     photonsBeforeGSFix_ecalPFClusterIso_isLoaded;
  vector<float> photonsBeforeGSFix_etaSC_;
  TBranch *photonsBeforeGSFix_etaSC_branch;
  bool     photonsBeforeGSFix_etaSC_isLoaded;
  vector<float> photonsBeforeGSFix_full3x3_e3x3_;
  TBranch *photonsBeforeGSFix_full3x3_e3x3_branch;
  bool     photonsBeforeGSFix_full3x3_e3x3_isLoaded;
  vector<float> photonsBeforeGSFix_full5x5_e1x5_;
  TBranch *photonsBeforeGSFix_full5x5_e1x5_branch;
  bool     photonsBeforeGSFix_full5x5_e1x5_isLoaded;
  vector<float> photonsBeforeGSFix_full5x5_e2x5Max_;
  TBranch *photonsBeforeGSFix_full5x5_e2x5Max_branch;
  bool     photonsBeforeGSFix_full5x5_e2x5Max_isLoaded;
  vector<float> photonsBeforeGSFix_full5x5_e5x5_;
  TBranch *photonsBeforeGSFix_full5x5_e5x5_branch;
  bool     photonsBeforeGSFix_full5x5_e5x5_isLoaded;
  vector<float> photonsBeforeGSFix_full5x5_hOverE_;
  TBranch *photonsBeforeGSFix_full5x5_hOverE_branch;
  bool     photonsBeforeGSFix_full5x5_hOverE_isLoaded;
  vector<float> photonsBeforeGSFix_full5x5_hOverEtowBC_;
  TBranch *photonsBeforeGSFix_full5x5_hOverEtowBC_branch;
  bool     photonsBeforeGSFix_full5x5_hOverEtowBC_isLoaded;
  vector<float> photonsBeforeGSFix_full5x5_r9_;
  TBranch *photonsBeforeGSFix_full5x5_r9_branch;
  bool     photonsBeforeGSFix_full5x5_r9_isLoaded;
  vector<float> photonsBeforeGSFix_full5x5_sigmaEtaEta_;
  TBranch *photonsBeforeGSFix_full5x5_sigmaEtaEta_branch;
  bool     photonsBeforeGSFix_full5x5_sigmaEtaEta_isLoaded;
  vector<float> photonsBeforeGSFix_full5x5_sigmaIEtaIEta_;
  TBranch *photonsBeforeGSFix_full5x5_sigmaIEtaIEta_branch;
  bool     photonsBeforeGSFix_full5x5_sigmaIEtaIEta_isLoaded;
  vector<float> photonsBeforeGSFix_hOverE_;
  TBranch *photonsBeforeGSFix_hOverE_branch;
  bool     photonsBeforeGSFix_hOverE_isLoaded;
  vector<float> photonsBeforeGSFix_hOverEtowBC_;
  TBranch *photonsBeforeGSFix_hOverEtowBC_branch;
  bool     photonsBeforeGSFix_hOverEtowBC_isLoaded;
  vector<float> photonsBeforeGSFix_hcalDepth1TowerSumEtBcConeDR03_;
  TBranch *photonsBeforeGSFix_hcalDepth1TowerSumEtBcConeDR03_branch;
  bool     photonsBeforeGSFix_hcalDepth1TowerSumEtBcConeDR03_isLoaded;
  vector<float> photonsBeforeGSFix_hcalDepth1TowerSumEtBcConeDR04_;
  TBranch *photonsBeforeGSFix_hcalDepth1TowerSumEtBcConeDR04_branch;
  bool     photonsBeforeGSFix_hcalDepth1TowerSumEtBcConeDR04_isLoaded;
  vector<float> photonsBeforeGSFix_hcalDepth2TowerSumEtBcConeDR03_;
  TBranch *photonsBeforeGSFix_hcalDepth2TowerSumEtBcConeDR03_branch;
  bool     photonsBeforeGSFix_hcalDepth2TowerSumEtBcConeDR03_isLoaded;
  vector<float> photonsBeforeGSFix_hcalDepth2TowerSumEtBcConeDR04_;
  TBranch *photonsBeforeGSFix_hcalDepth2TowerSumEtBcConeDR04_branch;
  bool     photonsBeforeGSFix_hcalDepth2TowerSumEtBcConeDR04_isLoaded;
  vector<float> photonsBeforeGSFix_hcalIso03_;
  TBranch *photonsBeforeGSFix_hcalIso03_branch;
  bool     photonsBeforeGSFix_hcalIso03_isLoaded;
  vector<float> photonsBeforeGSFix_hcalIso04_;
  TBranch *photonsBeforeGSFix_hcalIso04_branch;
  bool     photonsBeforeGSFix_hcalIso04_isLoaded;
  vector<float> photonsBeforeGSFix_hcalPFClusterIso_;
  TBranch *photonsBeforeGSFix_hcalPFClusterIso_branch;
  bool     photonsBeforeGSFix_hcalPFClusterIso_isLoaded;
  vector<float> photonsBeforeGSFix_hcalTowerSumEtBcConeDR03_;
  TBranch *photonsBeforeGSFix_hcalTowerSumEtBcConeDR03_branch;
  bool     photonsBeforeGSFix_hcalTowerSumEtBcConeDR03_isLoaded;
  vector<float> photonsBeforeGSFix_hcalTowerSumEtBcConeDR04_;
  TBranch *photonsBeforeGSFix_hcalTowerSumEtBcConeDR04_branch;
  bool     photonsBeforeGSFix_hcalTowerSumEtBcConeDR04_isLoaded;
  vector<float> photonsBeforeGSFix_mass_;
  TBranch *photonsBeforeGSFix_mass_branch;
  bool     photonsBeforeGSFix_mass_isLoaded;
  vector<float> photonsBeforeGSFix_neutralHadronIso_;
  TBranch *photonsBeforeGSFix_neutralHadronIso_branch;
  bool     photonsBeforeGSFix_neutralHadronIso_isLoaded;
  vector<float> photonsBeforeGSFix_ntkIsoHollow03_;
  TBranch *photonsBeforeGSFix_ntkIsoHollow03_branch;
  bool     photonsBeforeGSFix_ntkIsoHollow03_isLoaded;
  vector<float> photonsBeforeGSFix_ntkIsoHollow04_;
  TBranch *photonsBeforeGSFix_ntkIsoHollow04_branch;
  bool     photonsBeforeGSFix_ntkIsoHollow04_isLoaded;
  vector<float> photonsBeforeGSFix_ntkIsoSolid03_;
  TBranch *photonsBeforeGSFix_ntkIsoSolid03_branch;
  bool     photonsBeforeGSFix_ntkIsoSolid03_isLoaded;
  vector<float> photonsBeforeGSFix_ntkIsoSolid04_;
  TBranch *photonsBeforeGSFix_ntkIsoSolid04_branch;
  bool     photonsBeforeGSFix_ntkIsoSolid04_isLoaded;
  vector<float> photonsBeforeGSFix_phiSC_;
  TBranch *photonsBeforeGSFix_phiSC_branch;
  bool     photonsBeforeGSFix_phiSC_isLoaded;
  vector<float> photonsBeforeGSFix_photonIso_;
  TBranch *photonsBeforeGSFix_photonIso_branch;
  bool     photonsBeforeGSFix_photonIso_isLoaded;
  vector<float> photonsBeforeGSFix_recoChargedHadronIso_;
  TBranch *photonsBeforeGSFix_recoChargedHadronIso_branch;
  bool     photonsBeforeGSFix_recoChargedHadronIso_isLoaded;
  vector<float> photonsBeforeGSFix_recoNeutralHadronIso_;
  TBranch *photonsBeforeGSFix_recoNeutralHadronIso_branch;
  bool     photonsBeforeGSFix_recoNeutralHadronIso_isLoaded;
  vector<float> photonsBeforeGSFix_recoPhotonIso_;
  TBranch *photonsBeforeGSFix_recoPhotonIso_branch;
  bool     photonsBeforeGSFix_recoPhotonIso_isLoaded;
  vector<float> photonsBeforeGSFixscEtaWidth_;
  TBranch *photonsBeforeGSFixscEtaWidth_branch;
  bool     photonsBeforeGSFixscEtaWidth_isLoaded;
  vector<float> photonsBeforeGSFix_scIsEB_;
  TBranch *photonsBeforeGSFix_scIsEB_branch;
  bool     photonsBeforeGSFix_scIsEB_isLoaded;
  vector<float> photonsBeforeGSFixscPhiWidth_;
  TBranch *photonsBeforeGSFixscPhiWidth_branch;
  bool     photonsBeforeGSFixscPhiWidth_isLoaded;
  vector<float> photonsBeforeGSFix_scPreshowerEnergyPlane1_;
  TBranch *photonsBeforeGSFix_scPreshowerEnergyPlane1_branch;
  bool     photonsBeforeGSFix_scPreshowerEnergyPlane1_isLoaded;
  vector<float> photonsBeforeGSFix_scPreshowerEnergyPlane2_;
  TBranch *photonsBeforeGSFix_scPreshowerEnergyPlane2_branch;
  bool     photonsBeforeGSFix_scPreshowerEnergyPlane2_isLoaded;
  vector<float> photonsBeforeGSFix_scR_;
  TBranch *photonsBeforeGSFix_scR_branch;
  bool     photonsBeforeGSFix_scR_isLoaded;
  vector<float> photonsBeforeGSFix_scSeed2x5LeftRightAsym_;
  TBranch *photonsBeforeGSFix_scSeed2x5LeftRightAsym_branch;
  bool     photonsBeforeGSFix_scSeed2x5LeftRightAsym_isLoaded;
  vector<float> photonsBeforeGSFix_scSeed2x5TopBottomAsym_;
  TBranch *photonsBeforeGSFix_scSeed2x5TopBottomAsym_branch;
  bool     photonsBeforeGSFix_scSeed2x5TopBottomAsym_isLoaded;
  vector<float> photonsBeforeGSFixscSeedCalibratedEnergy_;
  TBranch *photonsBeforeGSFixscSeedCalibratedEnergy_branch;
  bool     photonsBeforeGSFixscSeedCalibratedEnergy_isLoaded;
  vector<float> photonsBeforeGSFix_scSeedCryEta_;
  TBranch *photonsBeforeGSFix_scSeedCryEta_branch;
  bool     photonsBeforeGSFix_scSeedCryEta_isLoaded;
  vector<float> photonsBeforeGSFix_scSeedCryIeta_;
  TBranch *photonsBeforeGSFix_scSeedCryIeta_branch;
  bool     photonsBeforeGSFix_scSeedCryIeta_isLoaded;
  vector<float> photonsBeforeGSFix_scSeedCryIphi_;
  TBranch *photonsBeforeGSFix_scSeedCryIphi_branch;
  bool     photonsBeforeGSFix_scSeedCryIphi_isLoaded;
  vector<float> photonsBeforeGSFix_scSeedCryIx_;
  TBranch *photonsBeforeGSFix_scSeedCryIx_branch;
  bool     photonsBeforeGSFix_scSeedCryIx_isLoaded;
  vector<float> photonsBeforeGSFix_scSeedCryIy_;
  TBranch *photonsBeforeGSFix_scSeedCryIy_branch;
  bool     photonsBeforeGSFix_scSeedCryIy_isLoaded;
  vector<float> photonsBeforeGSFix_scSeedCryPhi_;
  TBranch *photonsBeforeGSFix_scSeedCryPhi_branch;
  bool     photonsBeforeGSFix_scSeedCryPhi_isLoaded;
  vector<float> photonsBeforeGSFix_scSeedCryX_;
  TBranch *photonsBeforeGSFix_scSeedCryX_branch;
  bool     photonsBeforeGSFix_scSeedCryX_isLoaded;
  vector<float> photonsBeforeGSFix_scSeedCryY_;
  TBranch *photonsBeforeGSFix_scSeedCryY_branch;
  bool     photonsBeforeGSFix_scSeedCryY_isLoaded;
  vector<float> photonsBeforeGSFix_scSeedE2nd_;
  TBranch *photonsBeforeGSFix_scSeedE2nd_branch;
  bool     photonsBeforeGSFix_scSeedE2nd_isLoaded;
  vector<float> photonsBeforeGSFix_scSeedE2x5Bottom_;
  TBranch *photonsBeforeGSFix_scSeedE2x5Bottom_branch;
  bool     photonsBeforeGSFix_scSeedE2x5Bottom_isLoaded;
  vector<float> photonsBeforeGSFix_scSeedE2x5Left_;
  TBranch *photonsBeforeGSFix_scSeedE2x5Left_branch;
  bool     photonsBeforeGSFix_scSeedE2x5Left_isLoaded;
  vector<float> photonsBeforeGSFix_scSeedE2x5Right_;
  TBranch *photonsBeforeGSFix_scSeedE2x5Right_branch;
  bool     photonsBeforeGSFix_scSeedE2x5Right_isLoaded;
  vector<float> photonsBeforeGSFix_scSeedE2x5Top_;
  TBranch *photonsBeforeGSFix_scSeedE2x5Top_branch;
  bool     photonsBeforeGSFix_scSeedE2x5Top_isLoaded;
  vector<float> photonsBeforeGSFix_scSeedE3x3_;
  TBranch *photonsBeforeGSFix_scSeedE3x3_branch;
  bool     photonsBeforeGSFix_scSeedE3x3_isLoaded;
  vector<float> photonsBeforeGSFix_scSeedEBottom_;
  TBranch *photonsBeforeGSFix_scSeedEBottom_branch;
  bool     photonsBeforeGSFix_scSeedEBottom_isLoaded;
  vector<float> photonsBeforeGSFix_scSeedELeft_;
  TBranch *photonsBeforeGSFix_scSeedELeft_branch;
  bool     photonsBeforeGSFix_scSeedELeft_isLoaded;
  vector<float> photonsBeforeGSFix_scSeedERight_;
  TBranch *photonsBeforeGSFix_scSeedERight_branch;
  bool     photonsBeforeGSFix_scSeedERight_isLoaded;
  vector<float> photonsBeforeGSFix_scSeedETop_;
  TBranch *photonsBeforeGSFix_scSeedETop_branch;
  bool     photonsBeforeGSFix_scSeedETop_isLoaded;
  vector<float> photonsBeforeGSFix_scSeedEmax_;
  TBranch *photonsBeforeGSFix_scSeedEmax_branch;
  bool     photonsBeforeGSFix_scSeedEmax_isLoaded;
  vector<float> photonsBeforeGSFix_scSeedEta_;
  TBranch *photonsBeforeGSFix_scSeedEta_branch;
  bool     photonsBeforeGSFix_scSeedEta_isLoaded;
  vector<float> photonsBeforeGSFix_scSeedLeftRightAsym_;
  TBranch *photonsBeforeGSFix_scSeedLeftRightAsym_branch;
  bool     photonsBeforeGSFix_scSeedLeftRightAsym_isLoaded;
  vector<float> photonsBeforeGSFix_scSeedPhi_;
  TBranch *photonsBeforeGSFix_scSeedPhi_branch;
  bool     photonsBeforeGSFix_scSeedPhi_isLoaded;
  vector<float> photonsBeforeGSFixscSeedRawEnergy_;
  TBranch *photonsBeforeGSFixscSeedRawEnergy_branch;
  bool     photonsBeforeGSFixscSeedRawEnergy_isLoaded;
  vector<float> photonsBeforeGSFix_scSeedSigmaIetaIphi_;
  TBranch *photonsBeforeGSFix_scSeedSigmaIetaIphi_branch;
  bool     photonsBeforeGSFix_scSeedSigmaIetaIphi_isLoaded;
  vector<float> photonsBeforeGSFixscSeedSigmaIphiIphi_;
  TBranch *photonsBeforeGSFixscSeedSigmaIphiIphi_branch;
  bool     photonsBeforeGSFixscSeedSigmaIphiIphi_isLoaded;
  vector<float> photonsBeforeGSFix_scSeedSize_;
  TBranch *photonsBeforeGSFix_scSeedSize_branch;
  bool     photonsBeforeGSFix_scSeedSize_isLoaded;
  vector<float> photonsBeforeGSFix_scSeedTopBottomAsym_;
  TBranch *photonsBeforeGSFix_scSeedTopBottomAsym_branch;
  bool     photonsBeforeGSFix_scSeedTopBottomAsym_isLoaded;
  vector<float> photonsBeforeGSFix_sigmaEtaEta_;
  TBranch *photonsBeforeGSFix_sigmaEtaEta_branch;
  bool     photonsBeforeGSFix_sigmaEtaEta_isLoaded;
  vector<float> photonsBeforeGSFix_sigmaIEtaIEta_;
  TBranch *photonsBeforeGSFix_sigmaIEtaIEta_branch;
  bool     photonsBeforeGSFix_sigmaIEtaIEta_isLoaded;
  vector<float> photonsBeforeGSFix_tkIsoHollow03_;
  TBranch *photonsBeforeGSFix_tkIsoHollow03_branch;
  bool     photonsBeforeGSFix_tkIsoHollow03_isLoaded;
  vector<float> photonsBeforeGSFix_tkIsoHollow04_;
  TBranch *photonsBeforeGSFix_tkIsoHollow04_branch;
  bool     photonsBeforeGSFix_tkIsoHollow04_isLoaded;
  vector<float> photonsBeforeGSFix_tkIsoSolid03_;
  TBranch *photonsBeforeGSFix_tkIsoSolid03_branch;
  bool     photonsBeforeGSFix_tkIsoSolid03_isLoaded;
  vector<float> photonsBeforeGSFix_tkIsoSolid04_;
  TBranch *photonsBeforeGSFix_tkIsoSolid04_branch;
  bool     photonsBeforeGSFix_tkIsoSolid04_isLoaded;
  ...
  vector<vector<float> > elsBeforeGSFix_clusterCalibEnergy_;
  TBranch *elsBeforeGSFix_clusterCalibEnergy_branch;
  bool     elsBeforeGSFix_clusterCalibEnergy_isLoaded;
  vector<vector<float> > elsBeforeGSFix_clusterDEtaToCentroid_;
  TBranch *elsBeforeGSFix_clusterDEtaToCentroid_branch;
  bool     elsBeforeGSFix_clusterDEtaToCentroid_isLoaded;
  vector<vector<float> > elsBeforeGSFix_clusterDEtaToSeed_;
  TBranch *elsBeforeGSFix_clusterDEtaToSeed_branch;
  bool     elsBeforeGSFix_clusterDEtaToSeed_isLoaded;
  vector<vector<float> > elsBeforeGSFix_clusterDPhiToCentroid_;
  TBranch *elsBeforeGSFix_clusterDPhiToCentroid_branch;
  bool     elsBeforeGSFix_clusterDPhiToCentroid_isLoaded;
  vector<vector<float> > elsBeforeGSFix_clusterDPhiToSeed_;
  TBranch *elsBeforeGSFix_clusterDPhiToSeed_branch;
  bool     elsBeforeGSFix_clusterDPhiToSeed_isLoaded;
  vector<vector<float> > elsBeforeGSFix_clusterEta_;
  TBranch *elsBeforeGSFix_clusterEta_branch;
  bool     elsBeforeGSFix_clusterEta_isLoaded;
  vector<vector<float> > elsBeforeGSFix_clusterPhi_;
  TBranch *elsBeforeGSFix_clusterPhi_branch;
  bool     elsBeforeGSFix_clusterPhi_isLoaded;
  vector<vector<float> > elsBeforeGSFix_clusterRawEnergy_;
  TBranch *elsBeforeGSFix_clusterRawEnergy_branch;
  bool     elsBeforeGSFix_clusterRawEnergy_isLoaded;
  vector<vector<float> > elsBeforeGSFix_psClusterEta_;
  TBranch *elsBeforeGSFix_psClusterEta_branch;
  bool     elsBeforeGSFix_psClusterEta_isLoaded;
  vector<vector<float> > elsBeforeGSFix_psClusterPhi_;
  TBranch *elsBeforeGSFix_psClusterPhi_branch;
  bool     elsBeforeGSFix_psClusterPhi_isLoaded;
  vector<vector<float> > elsBeforeGSFix_psClusterRawEnergy_;
  TBranch *elsBeforeGSFix_psClusterRawEnergy_branch;
  bool     elsBeforeGSFix_psClusterRawEnergy_isLoaded;
  ...
  vector<vector<float> > photonsBeforeGSFix_clusterCalibEnergy_;
  TBranch *photonsBeforeGSFix_clusterCalibEnergy_branch;
  bool     photonsBeforeGSFix_clusterCalibEnergy_isLoaded;
  vector<vector<float> > photonsBeforeGSFix_clusterDEtaToCentroid_;
  TBranch *photonsBeforeGSFix_clusterDEtaToCentroid_branch;
  bool     photonsBeforeGSFix_clusterDEtaToCentroid_isLoaded;
  vector<vector<float> > photonsBeforeGSFix_clusterDEtaToSeed_;
  TBranch *photonsBeforeGSFix_clusterDEtaToSeed_branch;
  bool     photonsBeforeGSFix_clusterDEtaToSeed_isLoaded;
  vector<vector<float> > photonsBeforeGSFix_clusterDPhiToCentroid_;
  TBranch *photonsBeforeGSFix_clusterDPhiToCentroid_branch;
  bool     photonsBeforeGSFix_clusterDPhiToCentroid_isLoaded;
  vector<vector<float> > photonsBeforeGSFix_clusterDPhiToSeed_;
  TBranch *photonsBeforeGSFix_clusterDPhiToSeed_branch;
  bool     photonsBeforeGSFix_clusterDPhiToSeed_isLoaded;
  vector<vector<float> > photonsBeforeGSFix_clusterEta_;
  TBranch *photonsBeforeGSFix_clusterEta_branch;
  bool     photonsBeforeGSFix_clusterEta_isLoaded;
  vector<vector<float> > photonsBeforeGSFix_clusterPhi_;
  TBranch *photonsBeforeGSFix_clusterPhi_branch;
  bool     photonsBeforeGSFix_clusterPhi_isLoaded;
  vector<vector<float> > photonsBeforeGSFix_clusterRawEnergy_;
  TBranch *photonsBeforeGSFix_clusterRawEnergy_branch;
  bool     photonsBeforeGSFix_clusterRawEnergy_isLoaded;
  vector<vector<float> > photonsBeforeGSFix_psClusterEta_;
  TBranch *photonsBeforeGSFix_psClusterEta_branch;
  bool     photonsBeforeGSFix_psClusterEta_isLoaded;
  vector<vector<float> > photonsBeforeGSFix_psClusterPhi_;
  TBranch *photonsBeforeGSFix_psClusterPhi_branch;
  bool     photonsBeforeGSFix_psClusterPhi_isLoaded;
  vector<vector<float> > photonsBeforeGSFix_psClusterRawEnergy_;
  TBranch *photonsBeforeGSFix_psClusterRawEnergy_branch;
  bool     photonsBeforeGSFix_psClusterRawEnergy_isLoaded;
  ...
  vector<int> elsBeforeGSFix_N_ECALClusters_;
  TBranch *elsBeforeGSFix_N_ECALClusters_branch;
  bool     elsBeforeGSFix_N_ECALClusters_isLoaded;
  vector<int> elsBeforeGSFix_N_PSClusters_;
  TBranch *elsBeforeGSFix_N_PSClusters_branch;
  bool     elsBeforeGSFix_N_PSClusters_isLoaded;
  vector<int> elsBeforeGSFix_category_;
  TBranch *elsBeforeGSFix_category_branch;
  bool     elsBeforeGSFix_category_isLoaded;
  vector<int> elsBeforeGSFix_charge_;
  TBranch *elsBeforeGSFix_charge_branch;
  bool     elsBeforeGSFix_charge_isLoaded;
  vector<int> elsBeforeGSFix_ckf_charge_;
  TBranch *elsBeforeGSFix_ckf_charge_branch;
  bool     elsBeforeGSFix_ckf_charge_isLoaded;
  vector<int> elsBeforeGSFix_ckf_laywithmeas_;
  TBranch *elsBeforeGSFix_ckf_laywithmeas_branch;
  bool     elsBeforeGSFix_ckf_laywithmeas_isLoaded;
  vector<int> elsBeforeGSFix_class_;
  TBranch *elsBeforeGSFix_class_branch;
  bool     elsBeforeGSFix_class_isLoaded;
  vector<int> elsBeforeGSFix_exp_innerlayers_;
  TBranch *elsBeforeGSFix_exp_innerlayers_branch;
  bool     elsBeforeGSFix_exp_innerlayers_isLoaded;
  vector<int> elsBeforeGSFix_exp_outerlayers_;
  TBranch *elsBeforeGSFix_exp_outerlayers_branch;
  bool     elsBeforeGSFix_exp_outerlayers_isLoaded;
  vector<int> elsBeforeGSFix_fiduciality_;
  TBranch *elsBeforeGSFix_fiduciality_branch;
  bool     elsBeforeGSFix_fiduciality_isLoaded;
  vector<int> elsBeforeGSFix_hasGainSwitchFlag_;
  TBranch *elsBeforeGSFix_hasGainSwitchFlag_branch;
  bool     elsBeforeGSFix_hasGainSwitchFlag_isLoaded;
  vector<int> elsBeforeGSFix_isEB_;
  TBranch *elsBeforeGSFix_isEB_branch;
  bool     elsBeforeGSFix_isEB_isLoaded;
  vector<int> elsBeforeGSFix_isEcalDriven_;
  TBranch *elsBeforeGSFix_isEcalDriven_branch;
  bool     elsBeforeGSFix_isEcalDriven_isLoaded;
  vector<int> elsBeforeGSFix_isTrackerDriven_;
  TBranch *elsBeforeGSFix_isTrackerDriven_branch;
  bool     elsBeforeGSFix_isTrackerDriven_isLoaded;
  vector<int> elsBeforeGSFix_lostHits_;
  TBranch *elsBeforeGSFix_lostHits_branch;
  bool     elsBeforeGSFix_lostHits_isLoaded;
  vector<int> elsBeforeGSFix_lost_pixelhits_;
  TBranch *elsBeforeGSFix_lost_pixelhits_branch;
  bool     elsBeforeGSFix_lost_pixelhits_isLoaded;
  vector<int> elsBeforeGSFix_mc_patMatch_id_;
  TBranch *elsBeforeGSFix_mc_patMatch_id_branch;
  bool     elsBeforeGSFix_mc_patMatch_id_isLoaded;
  vector<int> elsBeforeGSFix_nSeed_;
  TBranch *elsBeforeGSFix_nSeed_branch;
  bool     elsBeforeGSFix_nSeed_isLoaded;
  vector<int> elsBeforeGSFix_nlayers_;
  TBranch *elsBeforeGSFix_nlayers_branch;
  bool     elsBeforeGSFix_nlayers_isLoaded;
  vector<int> elsBeforeGSFix_nlayers3D_;
  TBranch *elsBeforeGSFix_nlayers3D_branch;
  bool     elsBeforeGSFix_nlayers3D_isLoaded;
  vector<int> elsBeforeGSFix_nlayersLost_;
  TBranch *elsBeforeGSFix_nlayersLost_branch;
  bool     elsBeforeGSFix_nlayersLost_isLoaded;
  vector<int> elsBeforeGSFix_sccharge_;
  TBranch *elsBeforeGSFix_sccharge_branch;
  bool     elsBeforeGSFix_sccharge_isLoaded;
  vector<int> elsBeforeGSFix_trk_charge_;
  TBranch *elsBeforeGSFix_trk_charge_branch;
  bool     elsBeforeGSFix_trk_charge_isLoaded;
  vector<int> elsBeforeGSFix_type_;
  TBranch *elsBeforeGSFix_type_branch;
  bool     elsBeforeGSFix_type_isLoaded;
  vector<int> elsBeforeGSFix_validHits_;
  TBranch *elsBeforeGSFix_validHits_branch;
  bool     elsBeforeGSFix_validHits_isLoaded;
  vector<int> elsBeforeGSFix_valid_pixelhits_;
  TBranch *elsBeforeGSFix_valid_pixelhits_branch;
  bool     elsBeforeGSFix_valid_pixelhits_isLoaded;
  ...
  vector<int> els_hasGainSwitchFlag_;
  TBranch *els_hasGainSwitchFlag_branch;
  bool     els_hasGainSwitchFlag_isLoaded;
  ...
  vector<int> mus_pid_oldPFMuon_;
  TBranch *mus_pid_oldPFMuon_branch;
  bool     mus_pid_oldPFMuon_isLoaded;
  ...
  vector<int> pfcandsdiscard_IdAssociatedPV_;
  TBranch *pfcandsdiscard_IdAssociatedPV_branch;
  bool     pfcandsdiscard_IdAssociatedPV_isLoaded;
  vector<int> pfcandsdiscard_charge_;
  TBranch *pfcandsdiscard_charge_branch;
  bool     pfcandsdiscard_charge_isLoaded;
  vector<int> pfcandsdiscard_particleId_;
  TBranch *pfcandsdiscard_particleId_branch;
  bool     pfcandsdiscard_particleId_isLoaded;
  ...
  vector<int> photonsBeforeGSFix_N_ECALClusters_;
  TBranch *photonsBeforeGSFix_N_ECALClusters_branch;
  bool     photonsBeforeGSFix_N_ECALClusters_isLoaded;
  vector<int> photonsBeforeGSFix_N_PSClusters_;
  TBranch *photonsBeforeGSFix_N_PSClusters_branch;
  bool     photonsBeforeGSFix_N_PSClusters_isLoaded;
  vector<int> photonsBeforeGSFix_fiduciality_;
  TBranch *photonsBeforeGSFix_fiduciality_branch;
  bool     photonsBeforeGSFix_fiduciality_isLoaded;
  vector<int> photonsBeforeGSFix_hasGainSwitchFlag_;
  TBranch *photonsBeforeGSFix_hasGainSwitchFlag_branch;
  bool     photonsBeforeGSFix_hasGainSwitchFlag_isLoaded;
  vector<int> photonsBeforeGSFix_isEB_;
  TBranch *photonsBeforeGSFix_isEB_branch;
  bool     photonsBeforeGSFix_isEB_isLoaded;
  vector<int> photonsBeforeGSFix_photonID_loose_;
  TBranch *photonsBeforeGSFix_photonID_loose_branch;
  bool     photonsBeforeGSFix_photonID_loose_isLoaded;
  vector<int> photonsBeforeGSFix_photonID_tight_;
  TBranch *photonsBeforeGSFix_photonID_tight_branch;
  bool     photonsBeforeGSFix_photonID_tight_isLoaded;
  ...
  vector<int> photons_hasGainSwitchFlag_;
  TBranch *photons_hasGainSwitchFlag_branch;
  bool     photons_hasGainSwitchFlag_isLoaded;
  ...
  vector<vector<int> > elsBeforeGSFix_clusterInDynDPhi_;
  TBranch *elsBeforeGSFix_clusterInDynDPhi_branch;
  bool     elsBeforeGSFix_clusterInDynDPhi_isLoaded;
  vector<vector<int> > elsBeforeGSFix_clusterInMustache_;
  TBranch *elsBeforeGSFix_clusterInMustache_branch;
  bool     elsBeforeGSFix_clusterInMustache_isLoaded;
  vector<vector<int> > elsBeforeGSFix_PFCand_idx_;
  TBranch *elsBeforeGSFix_PFCand_idx_branch;
  bool     elsBeforeGSFix_PFCand_idx_isLoaded;
  ...
  vector<vector<int> > photonsBeforeGSFix_clusterInDynDPhi_;
  TBranch *photonsBeforeGSFix_clusterInDynDPhi_branch;
  bool     photonsBeforeGSFix_clusterInDynDPhi_isLoaded;
  vector<vector<int> > photonsBeforeGSFix_clusterInMustache_;
  TBranch *photonsBeforeGSFix_clusterInMustache_branch;
  bool     photonsBeforeGSFix_clusterInMustache_isLoaded;
  vector<vector<int> > photonsBeforeGSFix_PFCand_idx_;
  TBranch *photonsBeforeGSFix_PFCand_idx_branch;
  bool     photonsBeforeGSFix_PFCand_idx_isLoaded;
  ...
  vector<unsigned char> pfcandsdiscard_fromPV_;
  TBranch *pfcandsdiscard_fromPV_branch;
  bool     pfcandsdiscard_fromPV_isLoaded;
  vector<unsigned char> pfcandsdiscard_pvAssociationQuality_;
  TBranch *pfcandsdiscard_pvAssociationQuality_branch;
  bool     pfcandsdiscard_pvAssociationQuality_isLoaded;
  ...
  unsigned int evt_nelsBeforeGSFix_;
  TBranch *evt_nelsBeforeGSFix_branch;
  bool     evt_nelsBeforeGSFix_isLoaded;
  ...
  unsigned int evt_nphotonsBeforeGSFix_;
  TBranch *evt_nphotonsBeforeGSFix_branch;
  bool     evt_nphotonsBeforeGSFix_isLoaded;
...
void LoadAllBranches(); 
  ...
  const vector<bool> &elsBeforeGSFix_conv_vtx_flag();
  const vector<bool> &elsBeforeGSFix_isGsfCtfScPixChargeConsistent();
  const vector<bool> &elsBeforeGSFix_passingMvaPreselection();
  const vector<bool> &elsBeforeGSFix_passingPflowPreselection();
  ...
  const vector<bool> &pfcandsdiscard_isGlobalMuon();
  const vector<bool> &pfcandsdiscard_isStandAloneMuon();
  const vector<bool> &pfcands_isGlobalMuon();
  const vector<bool> &pfcands_isStandAloneMuon();
  const vector<bool> &photonsBeforeGSFix_haspixelSeed();
  const vector<bool> &photonsBeforeGSFix_passElectronVeto();
  ...
  const float &evt_egclean_calomet();
  const float &evt_egclean_calometPhi();
  const float &evt_egclean_pfmet();
  const float &evt_egclean_pfmet_ElectronEnDown();
  const float &evt_egclean_pfmet_ElectronEnUp();
  const float &evt_egclean_pfmet_JetEnDown();
  const float &evt_egclean_pfmet_JetEnUp();
  const float &evt_egclean_pfmet_JetResDown();
  const float &evt_egclean_pfmet_JetResUp();
  const float &evt_egclean_pfmet_MuonEnDown();
  const float &evt_egclean_pfmet_MuonEnUp();
  const float &evt_egclean_pfmetPhi();
  const float &evt_egclean_pfmetPhi_ElectronEnDown();
  const float &evt_egclean_pfmetPhi_ElectronEnUp();
  const float &evt_egclean_pfmetPhi_JetEnDown();
  const float &evt_egclean_pfmetPhi_JetEnUp();
  const float &evt_egclean_pfmetPhi_JetResDown();
  const float &evt_egclean_pfmetPhi_JetResUp();
  const float &evt_egclean_pfmetPhi_MuonEnDown();
  const float &evt_egclean_pfmetPhi_MuonEnUp();
  const float &evt_egclean_pfmetPhi_PhotonEnDown();
  const float &evt_egclean_pfmetPhi_PhotonEnUp();
  const float &evt_egclean_pfmetPhi_TauEnDown();
  const float &evt_egclean_pfmetPhi_TauEnUp();
  const float &evt_egclean_pfmetPhi_UnclusteredEnDown();
  const float &evt_egclean_pfmetPhi_UnclusteredEnUp();
  const float &evt_egclean_pfmetPhi_raw();
  const float &evt_egclean_pfmet_PhotonEnDown();
  const float &evt_egclean_pfmet_PhotonEnUp();
  const float &evt_egclean_pfmetSig();
  const float &evt_egclean_pfmetSignificance();
  const float &evt_egclean_pfmet_TauEnDown();
  const float &evt_egclean_pfmet_TauEnUp();
  const float &evt_egclean_pfmet_UnclusteredEnDown();
  const float &evt_egclean_pfmet_UnclusteredEnUp();
  const float &evt_egclean_pfmet_raw();
  const float &evt_egclean_pfsumet();
  const float &evt_egclean_pfsumet_raw();
  const float &evt_muegclean_calomet();
  const float &evt_muegclean_calometPhi();
  const float &evt_muegclean_pfmet();
  const float &evt_muegclean_pfmet_ElectronEnDown();
  const float &evt_muegclean_pfmet_ElectronEnUp();
  const float &evt_muegclean_pfmet_JetEnDown();
  const float &evt_muegclean_pfmet_JetEnUp();
  const float &evt_muegclean_pfmet_JetResDown();
  const float &evt_muegclean_pfmet_JetResUp();
  const float &evt_muegclean_pfmet_MuonEnDown();
  const float &evt_muegclean_pfmet_MuonEnUp();
  const float &evt_muegclean_pfmetPhi();
  const float &evt_muegclean_pfmetPhi_ElectronEnDown();
  const float &evt_muegclean_pfmetPhi_ElectronEnUp();
  const float &evt_muegclean_pfmetPhi_JetEnDown();
  const float &evt_muegclean_pfmetPhi_JetEnUp();
  const float &evt_muegclean_pfmetPhi_JetResDown();
  const float &evt_muegclean_pfmetPhi_JetResUp();
  const float &evt_muegclean_pfmetPhi_MuonEnDown();
  const float &evt_muegclean_pfmetPhi_MuonEnUp();
  const float &evt_muegclean_pfmetPhi_PhotonEnDown();
  const float &evt_muegclean_pfmetPhi_PhotonEnUp();
  const float &evt_muegclean_pfmetPhi_TauEnDown();
  const float &evt_muegclean_pfmetPhi_TauEnUp();
  const float &evt_muegclean_pfmetPhi_UnclusteredEnDown();
  const float &evt_muegclean_pfmetPhi_UnclusteredEnUp();
  const float &evt_muegclean_pfmetPhi_raw();
  const float &evt_muegclean_pfmet_PhotonEnDown();
  const float &evt_muegclean_pfmet_PhotonEnUp();
  const float &evt_muegclean_pfmetSig();
  const float &evt_muegclean_pfmetSignificance();
  const float &evt_muegclean_pfmet_TauEnDown();
  const float &evt_muegclean_pfmet_TauEnUp();
  const float &evt_muegclean_pfmet_UnclusteredEnDown();
  const float &evt_muegclean_pfmet_UnclusteredEnUp();
  const float &evt_muegclean_pfmet_raw();
  const float &evt_muegclean_pfsumet();
  const float &evt_muegclean_pfsumet_raw();
  const float &evt_muegcleanfix_calomet();
  const float &evt_muegcleanfix_calometPhi();
  const float &evt_muegcleanfix_pfmet();
  const float &evt_muegcleanfix_pfmet_ElectronEnDown();
  const float &evt_muegcleanfix_pfmet_ElectronEnUp();
  const float &evt_muegcleanfix_pfmet_JetEnDown();
  const float &evt_muegcleanfix_pfmet_JetEnUp();
  const float &evt_muegcleanfix_pfmet_JetResDown();
  const float &evt_muegcleanfix_pfmet_JetResUp();
  const float &evt_muegcleanfix_pfmet_MuonEnDown();
  const float &evt_muegcleanfix_pfmet_MuonEnUp();
  const float &evt_muegcleanfix_pfmetPhi();
  const float &evt_muegcleanfix_pfmetPhi_ElectronEnDown();
  const float &evt_muegcleanfix_pfmetPhi_ElectronEnUp();
  const float &evt_muegcleanfix_pfmetPhi_JetEnDown();
  const float &evt_muegcleanfix_pfmetPhi_JetEnUp();
  const float &evt_muegcleanfix_pfmetPhi_JetResDown();
  const float &evt_muegcleanfix_pfmetPhi_JetResUp();
  const float &evt_muegcleanfix_pfmetPhi_MuonEnDown();
  const float &evt_muegcleanfix_pfmetPhi_MuonEnUp();
  const float &evt_muegcleanfix_pfmetPhi_PhotonEnDown();
  const float &evt_muegcleanfix_pfmetPhi_PhotonEnUp();
  const float &evt_muegcleanfix_pfmetPhi_TauEnDown();
  const float &evt_muegcleanfix_pfmetPhi_TauEnUp();
  const float &evt_muegcleanfix_pfmetPhi_UnclusteredEnDown();
  const float &evt_muegcleanfix_pfmetPhi_UnclusteredEnUp();
  const float &evt_muegcleanfix_pfmetPhi_raw();
  const float &evt_muegcleanfix_pfmet_PhotonEnDown();
  const float &evt_muegcleanfix_pfmet_PhotonEnUp();
  const float &evt_muegcleanfix_pfmetSig();
  const float &evt_muegcleanfix_pfmetSignificance();
  const float &evt_muegcleanfix_pfmet_TauEnDown();
  const float &evt_muegcleanfix_pfmet_TauEnUp();
  const float &evt_muegcleanfix_pfmet_UnclusteredEnDown();
  const float &evt_muegcleanfix_pfmet_UnclusteredEnUp();
  const float &evt_muegcleanfix_pfmet_raw();
  const float &evt_muegcleanfix_pfsumet();
  const float &evt_muegcleanfix_pfsumet_raw();
  const float &evt_uncorr_calomet();
  const float &evt_uncorr_calometPhi();
  const float &evt_uncorr_pfmet();
  const float &evt_uncorr_pfmet_ElectronEnDown();
  const float &evt_uncorr_pfmet_ElectronEnUp();
  const float &evt_uncorr_pfmet_JetEnDown();
  const float &evt_uncorr_pfmet_JetEnUp();
  const float &evt_uncorr_pfmet_JetResDown();
  const float &evt_uncorr_pfmet_JetResUp();
  const float &evt_uncorr_pfmet_MuonEnDown();
  const float &evt_uncorr_pfmet_MuonEnUp();
  const float &evt_uncorr_pfmetPhi();
  const float &evt_uncorr_pfmetPhi_ElectronEnDown();
  const float &evt_uncorr_pfmetPhi_ElectronEnUp();
  const float &evt_uncorr_pfmetPhi_JetEnDown();
  const float &evt_uncorr_pfmetPhi_JetEnUp();
  const float &evt_uncorr_pfmetPhi_JetResDown();
  const float &evt_uncorr_pfmetPhi_JetResUp();
  const float &evt_uncorr_pfmetPhi_MuonEnDown();
  const float &evt_uncorr_pfmetPhi_MuonEnUp();
  const float &evt_uncorr_pfmetPhi_PhotonEnDown();
  const float &evt_uncorr_pfmetPhi_PhotonEnUp();
  const float &evt_uncorr_pfmetPhi_TauEnDown();
  const float &evt_uncorr_pfmetPhi_TauEnUp();
  const float &evt_uncorr_pfmetPhi_UnclusteredEnDown();
  const float &evt_uncorr_pfmetPhi_UnclusteredEnUp();
  const float &evt_uncorr_pfmetPhi_raw();
  const float &evt_uncorr_pfmet_PhotonEnDown();
  const float &evt_uncorr_pfmet_PhotonEnUp();
  const float &evt_uncorr_pfmetSig();
  const float &evt_uncorr_pfmetSignificance();
  const float &evt_uncorr_pfmet_TauEnDown();
  const float &evt_uncorr_pfmet_TauEnUp();
  const float &evt_uncorr_pfmet_UnclusteredEnDown();
  const float &evt_uncorr_pfmet_UnclusteredEnUp();
  const float &evt_uncorr_pfmet_raw();
  const float &evt_uncorr_pfsumet();
  const float &evt_uncorr_pfsumet_raw();
  ...
  const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &elsBeforeGSFix_mc_patMatch_p4();
  const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &elsBeforeGSFix_p4();
  const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &elsBeforeGSFix_p4In();
  const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &elsBeforeGSFix_p4Out();
  const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &elsBeforeGSFix_trk_p4();
  const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &elsBeforeGSFix_trk_vertex_p4();
  const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &elsBeforeGSFix_vertex_p4();
  ...
  const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &pfcandsdiscard_p4();
  ...
  const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &photonsBeforeGSFix_p4();
  ...
  const vector<float> &elsBeforeGSFix_bs2d();
  const vector<float> &elsBeforeGSFix_bs2derr();
  const vector<float> &elsBeforeGSFix_bs3d();
  const vector<float> &elsBeforeGSFix_bs3derr();
  const vector<float> &elsBeforeGSFix_chi2();
  const vector<float> &elsBeforeGSFix_ckf_chi2();
  const vector<float> &elsBeforeGSFix_ckf_ndof();
  const vector<float> &elsBeforeGSFix_clusterMaxDR();
  const vector<float> &elsBeforeGSFix_clusterMaxDRDEta();
  const vector<float> &elsBeforeGSFix_clusterMaxDRDPhi();
  const vector<float> &elsBeforeGSFix_clusterMaxDRRawEnergy();
  const vector<float> &elsBeforeGSFix_clustersMeanDEtaToSeed();
  const vector<float> &elsBeforeGSFix_clustersMeanDPhiToSeed();
  const vector<float> &elsBeforeGSFix_clustersMeanDRToSeed();
  const vector<float> &elsBeforeGSFix_clustersMeanRawEnergy();
  const vector<float> &elsBeforeGSFix_clustersRMSRawEnergy();
  const vector<float> &elsBeforeGSFix_conv_vtx_prob();
  const vector<float> &elsBeforeGSFix_d0();
  const vector<float> &elsBeforeGSFix_d0Err();
  const vector<float> &elsBeforeGSFix_d0corr();
  const vector<float> &elsBeforeGSFix_d0corrPhi();
  const vector<float> &elsBeforeGSFix_d0phiCov();
  const vector<float> &elsBeforeGSFix_dEtaIn();
  const vector<float> &elsBeforeGSFix_dEtaOut();
  const vector<float> &elsBeforeGSFix_dPhiIn();
  const vector<float> &elsBeforeGSFix_dPhiInPhiOut();
  const vector<float> &elsBeforeGSFix_dPhiOut();
  const vector<float> &elsBeforeGSFix_deltaEtaEleClusterTrackAtCalo();
  const vector<float> &elsBeforeGSFix_deltaPhiEleClusterTrackAtCalo();
  const vector<float> &elsBeforeGSFix_dxyPV();
  const vector<float> &elsBeforeGSFix_dzPV();
  const vector<float> &elsBeforeGSFix_e1x5();
  const vector<float> &elsBeforeGSFix_e1x5_full5x5();
  const vector<float> &elsBeforeGSFix_e2x5Max();
  const vector<float> &elsBeforeGSFix_e2x5Max_full5x5();
  const vector<float> &elsBeforeGSFix_e5x5();
  const vector<float> &elsBeforeGSFix_e5x5_full5x5();
  const vector<float> &elsBeforeGSFix_eOverPIn();
  const vector<float> &elsBeforeGSFix_eOverPOut();
  const vector<float> &elsBeforeGSFix_eSC();
  const vector<float> &elsBeforeGSFix_eSCPresh();
  const vector<float> &elsBeforeGSFix_eSCRaw();
  const vector<float> &elsBeforeGSFix_eSeed();
  const vector<float> &elsBeforeGSFix_eSeedOverPIn();
  const vector<float> &elsBeforeGSFix_eSeedOverPOut();
  const vector<float> &elsBeforeGSFix_ecalEnergy();
  const vector<float> &elsBeforeGSFix_ecalEnergyError();
  const vector<float> &elsBeforeGSFix_ecalIso();
  const vector<float> &elsBeforeGSFix_ecalIso04();
  const vector<float> &elsBeforeGSFix_ecalPFClusterIso();
  const vector<float> &elsBeforeGSFix_etaErr();
  const vector<float> &elsBeforeGSFix_etaSC();
  const vector<float> &elsBeforeGSFix_etaSCwidth();
  const vector<float> &elsBeforeGSFix_fbrem();
  const vector<float> &elsBeforeGSFix_full5x5_hOverE();
  const vector<float> &elsBeforeGSFix_hOverE();
  const vector<float> &elsBeforeGSFix_hOverEBC();
  const vector<float> &elsBeforeGSFix_hcalDepth1OverEcal();
  const vector<float> &elsBeforeGSFix_hcalDepth1TowerSumEt();
  const vector<float> &elsBeforeGSFix_hcalDepth1TowerSumEt04();
  const vector<float> &elsBeforeGSFix_hcalDepth2OverEcal();
  const vector<float> &elsBeforeGSFix_hcalDepth2TowerSumEt();
  const vector<float> &elsBeforeGSFix_hcalDepth2TowerSumEt04();
  const vector<float> &elsBeforeGSFix_hcalIso();
  const vector<float> &elsBeforeGSFix_hcalIso04();
  const vector<float> &elsBeforeGSFix_hcalPFClusterIso();
  const vector<float> &elsBeforeGSFix_ip2d();
  const vector<float> &elsBeforeGSFix_ip2derr();
  const vector<float> &elsBeforeGSFix_ip3d();
  const vector<float> &elsBeforeGSFix_ip3derr();
  const vector<float> &elsBeforeGSFix_mass();
  const vector<float> &elsBeforeGSFix_mc_patMatch_dr();
  const vector<float> &elsBeforeGSFix_miniIso_ch();
  const vector<float> &elsBeforeGSFix_miniIso_db();
  const vector<float> &elsBeforeGSFix_miniIso_em();
  const vector<float> &elsBeforeGSFix_miniIso_nh();
  const vector<float> &elsBeforeGSFix_miniIso_uncor();
  const vector<float> &elsBeforeGSFix_mva();
  const vector<float> &elsBeforeGSFix_ndof();
  const vector<float> &elsBeforeGSFix_pfChargedHadronIso();
  const vector<float> &elsBeforeGSFix_pfNeutralHadronIso();
  const vector<float> &elsBeforeGSFix_pfPUIso();
  const vector<float> &elsBeforeGSFix_pfPhotonIso();
  const vector<float> &elsBeforeGSFix_phiErr();
  const vector<float> &elsBeforeGSFix_phiSC();
  const vector<float> &elsBeforeGSFix_phiSCwidth();
  const vector<float> &elsBeforeGSFix_ptErr();
  const vector<float> &elsBeforeGSFix_ptErrGsf();
  const vector<float> &elsBeforeGSFix_r9();
  const vector<float> &elsBeforeGSFix_r9_full5x5();
  const vector<float> &elsBeforeGSFix_scIsEB();
  const vector<float> &elsBeforeGSFix_scPreshowerEnergyPlane1();
  const vector<float> &elsBeforeGSFix_scPreshowerEnergyPlane2();
  const vector<float> &elsBeforeGSFix_scR();
  const vector<float> &elsBeforeGSFix_scSeed2x5LeftRightAsym();
  const vector<float> &elsBeforeGSFix_scSeed2x5TopBottomAsym();
  const vector<float> &elsBeforeGSFix_scSeedCryEta();
  const vector<float> &elsBeforeGSFix_scSeedCryIeta();
  const vector<float> &elsBeforeGSFix_scSeedCryIphi();
  const vector<float> &elsBeforeGSFix_scSeedCryIx();
  const vector<float> &elsBeforeGSFix_scSeedCryIy();
  const vector<float> &elsBeforeGSFix_scSeedCryPhi();
  const vector<float> &elsBeforeGSFix_scSeedCryX();
  const vector<float> &elsBeforeGSFix_scSeedCryY();
  const vector<float> &elsBeforeGSFix_scSeedE2nd();
  const vector<float> &elsBeforeGSFix_scSeedE2x5Bottom();
  const vector<float> &elsBeforeGSFix_scSeedE2x5Left();
  const vector<float> &elsBeforeGSFix_scSeedE2x5Right();
  const vector<float> &elsBeforeGSFix_scSeedE2x5Top();
  const vector<float> &elsBeforeGSFix_scSeedE3x3();
  const vector<float> &elsBeforeGSFix_scSeedEBottom();
  const vector<float> &elsBeforeGSFix_scSeedELeft();
  const vector<float> &elsBeforeGSFix_scSeedERight();
  const vector<float> &elsBeforeGSFix_scSeedETop();
  const vector<float> &elsBeforeGSFix_scSeedEmax();
  const vector<float> &elsBeforeGSFix_scSeedEta();
  const vector<float> &elsBeforeGSFix_scSeedLeftRightAsym();
  const vector<float> &elsBeforeGSFix_scSeedPhi();
  const vector<float> &elsBeforeGSFix_scSeedSigmaIetaIphi();
  const vector<float> &elsBeforeGSFix_scSeedSize();
  const vector<float> &elsBeforeGSFix_scSeedTopBottomAsym();
  const vector<float> &elsBeforeGSFix_sigmaEtaEta();
  const vector<float> &elsBeforeGSFix_sigmaEtaEta_full5x5();
  const vector<float> &elsBeforeGSFix_sigmaIEtaIEta();
  const vector<float> &elsBeforeGSFix_sigmaIEtaIEta_full5x5();
  const vector<float> &elsBeforeGSFix_sigmaIPhiIPhi();
  const vector<float> &elsBeforeGSFix_sigmaIPhiIPhi_full5x5();
  const vector<float> &elsBeforeGSFix_tkIso();
  const vector<float> &elsBeforeGSFix_tkIso04();
  const vector<float> &elsBeforeGSFix_trackMomentumError();
  const vector<float> &elsBeforeGSFix_trkdr();
  const vector<float> &elsBeforeGSFix_trkshFrac();
  const vector<float> &elsBeforeGSFix_z0();
  const vector<float> &elsBeforeGSFix_z0Err();
  const vector<float> &elsBeforeGSFix_z0corr();
  ...
  const vector<float> &pfcandsdiscard_dz();
  const vector<float> &pfcandsdiscard_dzAssociatedPV();
  const vector<float> &pfcandsdiscard_hcalFraction();
  const vector<float> &pfcandsdiscard_mass();
  const vector<float> &pfcandsdiscard_puppiWeight();
  const vector<float> &pfcandsdiscard_puppiWeightNoLep();
  const vector<float> &pfcands_dz();
  const vector<float> &pfcands_dzAssociatedPV();
  const vector<float> &pfcands_hcalFraction();
  ...
  const vector<float> &pfjets_deepFlavourJetTagsProbb();
  const vector<float> &pfjets_deepFlavourJetTagsProbbb();
  const vector<float> &pfjets_deepFlavourJetTagsProbc();
  const vector<float> &pfjets_deepFlavourJetTagsProbcc();
  const vector<float> &pfjets_deepFlavourJetTagsProbudsg();
  ...
  const vector<float> &pfjets_puppi_deepFlavourJetTagsProbb();
  const vector<float> &pfjets_puppi_deepFlavourJetTagsProbbb();
  const vector<float> &pfjets_puppi_deepFlavourJetTagsProbc();
  const vector<float> &pfjets_puppi_deepFlavourJetTagsProbcc();
  const vector<float> &pfjets_puppi_deepFlavourJetTagsProbudsg();
  ...
  const vector<float> &photonsBeforeGSFix_chargedHadronIso();
  const vector<float> &photonsBeforeGSFix_clusterMaxDR();
  const vector<float> &photonsBeforeGSFix_clusterMaxDRDEta();
  const vector<float> &photonsBeforeGSFix_clusterMaxDRDPhi();
  const vector<float> &photonsBeforeGSFix_clusterMaxDRRawEnergy();
  const vector<float> &photonsBeforeGSFix_clustersMeanDEtaToSeed();
  const vector<float> &photonsBeforeGSFix_clustersMeanDPhiToSeed();
  const vector<float> &photonsBeforeGSFix_clustersMeanDRToSeed();
  const vector<float> &photonsBeforeGSFix_clustersMeanRawEnergy();
  const vector<float> &photonsBeforeGSFix_clustersRMSRawEnergy();
  const vector<float> &photonsBeforeGSFix_e1x5();
  const vector<float> &photonsBeforeGSFix_e2x5Max();
  const vector<float> &photonsBeforeGSFix_e3x3();
  const vector<float> &photonsBeforeGSFix_e5x5();
  const vector<float> &photonsBeforeGSFix_eSC();
  const vector<float> &photonsBeforeGSFix_eSCPresh();
  const vector<float> &photonsBeforeGSFix_eSCRaw();
  const vector<float> &photonsBeforeGSFix_ecalIso03();
  const vector<float> &photonsBeforeGSFix_ecalIso04();
  const vector<float> &photonsBeforeGSFix_ecalPFClusterIso();
  const vector<float> &photonsBeforeGSFix_etaSC();
  const vector<float> &photonsBeforeGSFix_full3x3_e3x3();
  const vector<float> &photonsBeforeGSFix_full5x5_e1x5();
  const vector<float> &photonsBeforeGSFix_full5x5_e2x5Max();
  const vector<float> &photonsBeforeGSFix_full5x5_e5x5();
  const vector<float> &photonsBeforeGSFix_full5x5_hOverE();
  const vector<float> &photonsBeforeGSFix_full5x5_hOverEtowBC();
  const vector<float> &photonsBeforeGSFix_full5x5_r9();
  const vector<float> &photonsBeforeGSFix_full5x5_sigmaEtaEta();
  const vector<float> &photonsBeforeGSFix_full5x5_sigmaIEtaIEta();
  const vector<float> &photonsBeforeGSFix_hOverE();
  const vector<float> &photonsBeforeGSFix_hOverEtowBC();
  const vector<float> &photonsBeforeGSFix_hcalDepth1TowerSumEtBcConeDR03();
  const vector<float> &photonsBeforeGSFix_hcalDepth1TowerSumEtBcConeDR04();
  const vector<float> &photonsBeforeGSFix_hcalDepth2TowerSumEtBcConeDR03();
  const vector<float> &photonsBeforeGSFix_hcalDepth2TowerSumEtBcConeDR04();
  const vector<float> &photonsBeforeGSFix_hcalIso03();
  const vector<float> &photonsBeforeGSFix_hcalIso04();
  const vector<float> &photonsBeforeGSFix_hcalPFClusterIso();
  const vector<float> &photonsBeforeGSFix_hcalTowerSumEtBcConeDR03();
  const vector<float> &photonsBeforeGSFix_hcalTowerSumEtBcConeDR04();
  const vector<float> &photonsBeforeGSFix_mass();
  const vector<float> &photonsBeforeGSFix_neutralHadronIso();
  const vector<float> &photonsBeforeGSFix_ntkIsoHollow03();
  const vector<float> &photonsBeforeGSFix_ntkIsoHollow04();
  const vector<float> &photonsBeforeGSFix_ntkIsoSolid03();
  const vector<float> &photonsBeforeGSFix_ntkIsoSolid04();
  const vector<float> &photonsBeforeGSFix_phiSC();
  const vector<float> &photonsBeforeGSFix_photonIso();
  const vector<float> &photonsBeforeGSFix_recoChargedHadronIso();
  const vector<float> &photonsBeforeGSFix_recoNeutralHadronIso();
  const vector<float> &photonsBeforeGSFix_recoPhotonIso();
  const vector<float> &photonsBeforeGSFixscEtaWidth();
  const vector<float> &photonsBeforeGSFix_scIsEB();
  const vector<float> &photonsBeforeGSFixscPhiWidth();
  const vector<float> &photonsBeforeGSFix_scPreshowerEnergyPlane1();
  const vector<float> &photonsBeforeGSFix_scPreshowerEnergyPlane2();
  const vector<float> &photonsBeforeGSFix_scR();
  const vector<float> &photonsBeforeGSFix_scSeed2x5LeftRightAsym();
  const vector<float> &photonsBeforeGSFix_scSeed2x5TopBottomAsym();
  const vector<float> &photonsBeforeGSFixscSeedCalibratedEnergy();
  const vector<float> &photonsBeforeGSFix_scSeedCryEta();
  const vector<float> &photonsBeforeGSFix_scSeedCryIeta();
  const vector<float> &photonsBeforeGSFix_scSeedCryIphi();
  const vector<float> &photonsBeforeGSFix_scSeedCryIx();
  const vector<float> &photonsBeforeGSFix_scSeedCryIy();
  const vector<float> &photonsBeforeGSFix_scSeedCryPhi();
  const vector<float> &photonsBeforeGSFix_scSeedCryX();
  const vector<float> &photonsBeforeGSFix_scSeedCryY();
  const vector<float> &photonsBeforeGSFix_scSeedE2nd();
  const vector<float> &photonsBeforeGSFix_scSeedE2x5Bottom();
  const vector<float> &photonsBeforeGSFix_scSeedE2x5Left();
  const vector<float> &photonsBeforeGSFix_scSeedE2x5Right();
  const vector<float> &photonsBeforeGSFix_scSeedE2x5Top();
  const vector<float> &photonsBeforeGSFix_scSeedE3x3();
  const vector<float> &photonsBeforeGSFix_scSeedEBottom();
  const vector<float> &photonsBeforeGSFix_scSeedELeft();
  const vector<float> &photonsBeforeGSFix_scSeedERight();
  const vector<float> &photonsBeforeGSFix_scSeedETop();
  const vector<float> &photonsBeforeGSFix_scSeedEmax();
  const vector<float> &photonsBeforeGSFix_scSeedEta();
  const vector<float> &photonsBeforeGSFix_scSeedLeftRightAsym();
  const vector<float> &photonsBeforeGSFix_scSeedPhi();
  const vector<float> &photonsBeforeGSFixscSeedRawEnergy();
  const vector<float> &photonsBeforeGSFix_scSeedSigmaIetaIphi();
  const vector<float> &photonsBeforeGSFixscSeedSigmaIphiIphi();
  const vector<float> &photonsBeforeGSFix_scSeedSize();
  const vector<float> &photonsBeforeGSFix_scSeedTopBottomAsym();
  const vector<float> &photonsBeforeGSFix_sigmaEtaEta();
  const vector<float> &photonsBeforeGSFix_sigmaIEtaIEta();
  const vector<float> &photonsBeforeGSFix_tkIsoHollow03();
  const vector<float> &photonsBeforeGSFix_tkIsoHollow04();
  const vector<float> &photonsBeforeGSFix_tkIsoSolid03();
  const vector<float> &photonsBeforeGSFix_tkIsoSolid04();
  ...
  const vector<vector<float> > &elsBeforeGSFix_clusterCalibEnergy();
  const vector<vector<float> > &elsBeforeGSFix_clusterDEtaToCentroid();
  const vector<vector<float> > &elsBeforeGSFix_clusterDEtaToSeed();
  const vector<vector<float> > &elsBeforeGSFix_clusterDPhiToCentroid();
  const vector<vector<float> > &elsBeforeGSFix_clusterDPhiToSeed();
  const vector<vector<float> > &elsBeforeGSFix_clusterEta();
  const vector<vector<float> > &elsBeforeGSFix_clusterPhi();
  const vector<vector<float> > &elsBeforeGSFix_clusterRawEnergy();
  const vector<vector<float> > &elsBeforeGSFix_psClusterEta();
  const vector<vector<float> > &elsBeforeGSFix_psClusterPhi();
  const vector<vector<float> > &elsBeforeGSFix_psClusterRawEnergy();
  ...
  const vector<vector<float> > &photonsBeforeGSFix_clusterCalibEnergy();
  const vector<vector<float> > &photonsBeforeGSFix_clusterDEtaToCentroid();
  const vector<vector<float> > &photonsBeforeGSFix_clusterDEtaToSeed();
  const vector<vector<float> > &photonsBeforeGSFix_clusterDPhiToCentroid();
  const vector<vector<float> > &photonsBeforeGSFix_clusterDPhiToSeed();
  const vector<vector<float> > &photonsBeforeGSFix_clusterEta();
  const vector<vector<float> > &photonsBeforeGSFix_clusterPhi();
  const vector<vector<float> > &photonsBeforeGSFix_clusterRawEnergy();
  const vector<vector<float> > &photonsBeforeGSFix_psClusterEta();
  const vector<vector<float> > &photonsBeforeGSFix_psClusterPhi();
  const vector<vector<float> > &photonsBeforeGSFix_psClusterRawEnergy();
  ...
  const vector<int> &elsBeforeGSFix_N_ECALClusters();
  const vector<int> &elsBeforeGSFix_N_PSClusters();
  const vector<int> &elsBeforeGSFix_category();
  const vector<int> &elsBeforeGSFix_charge();
  const vector<int> &elsBeforeGSFix_ckf_charge();
  const vector<int> &elsBeforeGSFix_ckf_laywithmeas();
  const vector<int> &elsBeforeGSFix_class();
  const vector<int> &elsBeforeGSFix_exp_innerlayers();
  const vector<int> &elsBeforeGSFix_exp_outerlayers();
  const vector<int> &elsBeforeGSFix_fiduciality();
  const vector<int> &elsBeforeGSFix_hasGainSwitchFlag();
  const vector<int> &elsBeforeGSFix_isEB();
  const vector<int> &elsBeforeGSFix_isEcalDriven();
  const vector<int> &elsBeforeGSFix_isTrackerDriven();
  const vector<int> &elsBeforeGSFix_lostHits();
  const vector<int> &elsBeforeGSFix_lost_pixelhits();
  const vector<int> &elsBeforeGSFix_mc_patMatch_id();
  const vector<int> &elsBeforeGSFix_nSeed();
  const vector<int> &elsBeforeGSFix_nlayers();
  const vector<int> &elsBeforeGSFix_nlayers3D();
  const vector<int> &elsBeforeGSFix_nlayersLost();
  const vector<int> &elsBeforeGSFix_sccharge();
  const vector<int> &elsBeforeGSFix_trk_charge();
  const vector<int> &elsBeforeGSFix_type();
  const vector<int> &elsBeforeGSFix_validHits();
  const vector<int> &elsBeforeGSFix_valid_pixelhits();
  ...
  const vector<int> &els_hasGainSwitchFlag();
  ...
  const vector<int> &mus_pid_oldPFMuon();
  ...
  const vector<int> &pfcandsdiscard_IdAssociatedPV();
  const vector<int> &pfcandsdiscard_charge();
  const vector<int> &pfcandsdiscard_particleId();
  ...
  const vector<int> &photonsBeforeGSFix_N_ECALClusters();
  const vector<int> &photonsBeforeGSFix_N_PSClusters();
  const vector<int> &photonsBeforeGSFix_fiduciality();
  const vector<int> &photonsBeforeGSFix_hasGainSwitchFlag();
  const vector<int> &photonsBeforeGSFix_isEB();
  const vector<int> &photonsBeforeGSFix_photonID_loose();
  const vector<int> &photonsBeforeGSFix_photonID_tight();
  const vector<int> &photons_N_ECALClusters();
  const vector<int> &photons_N_PSClusters();
  const vector<int> &photons_fiduciality();
  const vector<int> &photons_hasGainSwitchFlag();
  ...
  const vector<vector<int> > &elsBeforeGSFix_clusterInDynDPhi();
  const vector<vector<int> > &elsBeforeGSFix_clusterInMustache();
  const vector<vector<int> > &elsBeforeGSFix_PFCand_idx();
  ...
  const vector<vector<int> > &photonsBeforeGSFix_clusterInDynDPhi();
  const vector<vector<int> > &photonsBeforeGSFix_clusterInMustache();
  const vector<vector<int> > &photonsBeforeGSFix_PFCand_idx();
  ...
  const vector<unsigned char> &pfcandsdiscard_fromPV();
  const vector<unsigned char> &pfcandsdiscard_pvAssociationQuality();
  ...
  const unsigned int &evt_nelsBeforeGSFix();
  ...
  const unsigned int &evt_nphotonsBeforeGSFix();
