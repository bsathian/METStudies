...
#        process,
#        isData = opts.data, #False for MC samples
#        fixEE2017 = True,
#        postfix = "ModifiedMET"
#)

process.outpath = cms.EndPath(process.out)
#process.outpath = cms.EndPath(process.fullPatMetSequenceModifiedMET * process.out)
...
process.out.outputCommands = cms.untracked.vstring( 'drop *' )
#process.out.outputCommands.extend(cms.untracked.vstring("keep *_slimmedMETs_*_*"))
process.out.outputCommands.extend(cms.untracked.vstring("keep *_slimmedMETsModifiedMET_*_*"))
...
#process.source.fileNames = cms.untracked.vstring('/store/data/Run2017B/DoubleMuon/MINIAOD/31Mar2018-v1/00000/4018EDF1-4737-E811-84D5-801844DEF4C0.root')
process.source.fileNames = cms.untracked.vstring('/store/data/Run2017F/DoubleMuon/MINIAOD/17Nov2017-v1/50000/009DC3A2-A7DE-E711-99F7-02163E013717.root')
#process.source.fileNames = cms.untracked.vstring('/store/mc/RunIIFall17MiniAOD/TTTo2L2Nu_TuneCP5_PSweights_13TeV-powheg-pythia8/MINIAODSIM/94X_mc2017_realistic_v10-v1/60000/F8225CC1-B6E5-E711-8911-001E67E6F922.root')
