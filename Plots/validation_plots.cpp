...
int main(int argc, char* argv[])
{
  ...
  int histIdx = 3; // run F
  //TFile* file = new TFile("../histograms/Zll_histograms_F.root");
  ...
  make_comparison(c1, histIdx, file, output_name, "hpfModifiedMET_recipe", "hpfModifiedMET_myImplementation", "E_{T}^{miss} [GeV]", lumi, -1, {"Modified Type-1 Corr. Met"}, 2); 
